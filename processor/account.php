				...
				if (!empty($_POST['method']))
				{
					...
					if ($clearedForUpdate)
					{
						...
						if ($this->duplicateSMSNumberExists($User, $normalNumber))
						{
							echo json_encode(array(
								'processor_success' => false,
								'processor_message' => 'This phone number is in use by another account. If you are unable to remove the number, please <a href="/main.php?static=contact_us">contact Dream Dinners support.</a>'
							));
							exit;
						}

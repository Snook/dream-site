<?php
/**
 * Table Definition for dashboard_metrics_rankings
 */
require_once 'DAO.inc';

class DAO_Dashboard_metrics_rankings extends DAO
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'dashboard_metrics_rankings';      // table name
    ...
    /* Static get */
    function staticGet($class,$k,$v=NULL) { return DB_DataObject::staticGet('DAO_Dashboard_metrics_rankings',$k,$v); }

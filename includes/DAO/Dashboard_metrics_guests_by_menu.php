<?php
/**
 * Table Definition for dashboard_metrics_guests_by_menu
 */
require_once 'DAO.inc';

class DAO_Dashboard_metrics_guests_by_menu extends DAO
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'dashboard_metrics_guests_by_menu';        // table name
	...
	public $guest_count_existing_additional;            // int(8)
	...
	public $guest_count_existing_delivered;			// int(8)
	public $guest_count_reacquired_regular;    // int(8)
	public $guest_count_reacquired_additional;    // int(8)
	...
	public $guest_count_reacquired_delivered;			// int(8)
    public $guest_count_new_regular;         // int(8)
	public $guest_count_new_additional;         // int(8)
    public $guest_count_new_taste;           // int(8)
    public $guest_count_new_intro;           // int(8)
	public $guest_count_new_fundraiser;			// int(8)
	public $guest_count_new_delivered;			// int(8)
	public $guest_count_rsvp;					// int(8)
	public $guest_count_rsvp_upgraded;			//int(8)
	public $unique_new_guest_count;				// int(8)
	public $unique_reacquired_guest_count;		// int(8)
    public $instore_signup_total;            // int(8)
    public $instore_signup_existing_regular;         // int(8)
	public $instore_signup_existing_additional;         // int(8)
	...
	public $instore_signup_reacquired_additional;    // int(8)
	...
	public $instore_signup_new_additional;      // int(8)
	...
	public $avg_servings_per_guest_additional;		// real(8)
    public $avg_servings_per_guest_existing_regular;    // real(8)
	public $avg_servings_per_guest_existing_additional;    // real(8)
	...
	public $avg_servings_per_guest_existing_delivered;			// real(8)
	public $avg_servings_per_guest_reacquired_regular;    // real(8)
	public $avg_servings_per_guest_reacquired_additional;    // real(8)
	...
	public $avg_servings_per_guest_reacquired_delivered;			// real(8)
    public $avg_servings_per_guest_new_regular;    // real(8)
	public $avg_servings_per_guest_new_additional;    // real(8)
	...
	public $avg_servings_per_guest_new_delivered;			// real(8)
	...
	public $sessions_count_mfy_walk_in;     // mediumint(6)  unsigned
    public $sessions_count_mfy_delivery;     // mediumint(6)  unsigned
	public $sessions_count_mfy_community_pickup;     // mediumint(6)  unsigned
    public $sessions_count_taste;            // int(6)
	public $sessions_count_fundraiser;			// int(6)
	public $sessions_count_delivered;			// int(6)
	public $retained_guest_count;				//int(6)
    public $orders_count_all;                // int(6)
    public $orders_count_regular;            // int(6)
	public $orders_count_additional;            // int(6)
    public $orders_count_mfy;                // int(6)
    public $orders_count_mfy_delivery;       // mediumint(6)  unsigned
	public $orders_count_mfy_walk_in;       // mediumint(6)  unsigned
	public $orders_count_mfy_community_pickup;       // mediumint(6)  unsigned
    public $orders_count_taste;              // int(6)
	public $orders_count_fundraiser;			// int(6)
	public $orders_count_delivered;			// int(6)
	...
	public $orders_count_additional_existing_guests;	// int(6)
	public $orders_count_additional_new_guests;		// int(6)
	public $orders_count_additional_reacquired_guests;// int(6)
	...
	public $orders_count_delivered_existing_guests;			// int(6)
	public $orders_count_delivered_new_guests;			// int(6)
	public $orders_count_delivered_reacquired_guests;			// int(6)
    public $lost_guests_at_45_days;          // int(6)
    public $lifestyle_guest_count;             // int(6)
    public $retention_count;				// int (6)
    public $growth_scorecard_value;            // int(6)
    public $dinner_dollars_used;                // decimal(8,2)
    public $new_guests_with_follow_up;        // int(6)
    public $timestamp_updated;               // timestamp(19)  not_null unsigned zerofill binary timestamp
    public $timestamp_created;               // timestamp(19)  not_null unsigned zerofill binary
    public $is_deleted;                      // int(4)  not_null

    /* Static get */
    function staticGet($class,$k,$v=NULL) { return DB_DataObject::staticGet('DAO_Dashboard_metrics_guests_by_menu',$k,$v); }

<?php
/**
 * Table Definition for dashboard_metrics_agr_by_menu
 */
require_once 'DAO.inc';

class DAO_Dashboard_metrics_agr_by_menu extends DAO
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'dashboard_metrics_agr_by_menu';           // table name
    ...
    public $agr_by_session_mfy_delivery;     // decimal(12)
	public $agr_by_session_mfy_walk_in;     // decimal(12)
	public $agr_by_session_mfy_community_pick;     // decimal(12)
    public $agr_by_session_fundraiser;			// real(12)
	public $agr_by_session_delivered;			// real(12)
	public $agr_by_order_regular;            // real(12)
	public $agr_by_order_additional;            // real(12)
    public $agr_by_order_intro;              // real(12)
    public $agr_by_order_taste;              // real(12)
	public $agr_by_order_fundraiser;			// real(12)
	public $agr_by_order_delivered;			// real(12)
    public $agr_by_guest_existing_regular;    // real(12)
	public $agr_by_guest_existing_additional;    // real(12)
	...
	public $agr_by_guest_reacquired_delivered;			// real(12)
	public $agr_from_membership_fees;				// real (12)
	public $agr_from_door_dash;				// real (12)
    public $revenue_by_session_standard;    // real(12)
    public $revenue_by_session_taste;    // real(12)
    public $revenue_by_session_mfy;    // real(12)
    public $revenue_by_session_mfy_delivery;    // decimal(12)
	public $revenue_by_session_mfy_walk_in;    // decimal(12)
	public $revenue_by_session_mfy_community_pickup;    // decimal(12)
	public $revenue_by_session_fundraiser;			// real(12)
	public $revenue_by_session_delivered;			// real(12)
	...
	public $revenue_by_order_delivered;			// real(12)
	...
	public $revenue_by_guest_existing_delivered;			// real(12)
	...
	public $revenue_by_guest_new_delivered;			// real(12)
	...
	public $revenue_by_guest_reacquired_delivered;			// real(12)
	public $revenue_from_membership_fees;				// real (12)
	public $revenue_from_door_dash;				// real (12)
    public $avg_ticket_all;                  // real(8)
    public $avg_ticket_regular;				 //real(8)
    public $avg_ticket_by_guest_existing_regular;    // real(8)
	public $avg_ticket_by_guest_existing_additional;    // real(8)
	...
	public $avg_ticket_by_guest_existing_delivered;			// real(8)
    public $avg_ticket_by_guest_new_regular;    // real(8)
	public $avg_ticket_by_guest_new_additional;    // real(8)
	...
	public $avg_ticket_by_guest_new_delivered;			// real(8)
	public $avg_ticket_by_guest_reacquired_regular;    // real(8)
	public $avg_ticket_by_guest_reacquired_additional;    // real(8)
	...
	public $avg_ticket_by_guest_reacquired_delivered;			// real(8)
    public $addon_sales_total;               // real(12)
    public $addon_sales_by_guest_existing_regular;    // real(8)
	public $addon_sales_by_guest_existing_additional;    // real(8)
	...
	public $addon_sales_by_guest_new_additional;    // real(8)
	...
	public $addon_sales_by_guest_reacquired_additional;    // real(8)
    ...
    /* Static get */
    function staticGet($class,$k,$v=NULL) { return DB_DataObject::staticGet('DAO_Dashboard_metrics_agr_by_menu',$k,$v); }

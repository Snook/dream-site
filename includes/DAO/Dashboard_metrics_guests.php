<?php
/**
 * Table Definition for dashboard_metrics_guests
 */
require_once 'DAO.inc';

class DAO_Dashboard_metrics_guests extends DAO
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'dashboard_metrics_guests';        // table name
    ...
    /* Static get */
    function staticGet($class,$k,$v=NULL) { return DB_DataObject::staticGet('DAO_Dashboard_metrics_guests',$k,$v); }

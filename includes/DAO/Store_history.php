<?php
/**
 * Table Definition for store_history
 */
require_once 'DAO.inc';

class DAO_Store_history extends DAO
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'store_history';           // table name
    public $id;                              // int(11)  not_null primary_key unsigned auto_increment
    public $user_id;                         // int(11)  unsigned
    public $store_id;                        // int(11)
    public $order_id;                        // int(11)
    public $payment_id;                      // int(11)
    public $event_id;                        // int(8)  not_null
    ...
    /* Static get */
    function staticGet($class,$k,$v=NULL) { return DB_DataObject::staticGet('DAO_Store_history',$k,$v); }

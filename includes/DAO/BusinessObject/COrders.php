...
*/
	...
	function processOrder($payments, $useTransaction = true)
	{
		...
		if (!empty($this->menu_id) && $this->menu_id <= 278 && CPointsUserHistory::userIsActiveInProgram($DAO_user))
		{
	...
	{
		if ($this->getFoodTotal() > 0 && $this->getServingsTotalCount() > 0)
		{
	...
	{
		if ($this->getFoodTotal() > 0 && $this->getServingsCoreTotalCount() > 0)
		{

...
try
{
	...
	$affectedOrders->query("select
		...
		and ((b.timestamp_updated > '2023-02-26 21:00:00' and b.timestamp_updated < '2023-03-03 00:00:00') OR (b.timestamp_created > '2023-02-26 21:00:00' and b.timestamp_created < '2023-03-03 00:00:00'))

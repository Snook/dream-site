...
<table role="presentation" width="100%" align="center" cellpadding="2">
  ...
  <table role="presentation" width="100%" align="center" cellpadding="2">
   ...
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    ...
    <td width="50%" align="left" valign="middle"><?php echo $this->credit_card_type?></td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
   ...
   <p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;"><strong>Have questions?</strong> To view the complete Gift Card Policies &amp; Terms online or if you have questions regarding your Gift Card or Customer Service options please visit <a href="<?php echo HTTPS_SERVER ?>/giftcards" style="color:#c0362c;"><?php echo HTTPS_SERVER; ?>/giftcards</a>.</p></td>
</tr>
</table>
</body>
</html>
...
<table role="presentation" width="100%" align="center" cellpadding="2">
    ...
    <table role="presentation" width="100%" align="center" cellpadding="2">
     ...
     <!--end payment details table-->
      ...
      <p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;"><strong>Have questions?</strong> To view the complete Gift Card Policies &amp; Terms online or if you have questions regarding your Gift Card or Customer Service options please visit <a href="<?= HTTPS_SERVER ?>/giftcards" style="color:#c0362c;">DreamDinners.com/giftcards</a>.</p></td>
</tr>
</table>
</body>
</html>
...
<td width="300" align="right" style="padding: 5px"><a href="<?=HTTPS_BASE?>my-events?sid=<?=$this->sessionInfo['session_id']?>">Invite Friends</a> | <a href="<?php echo HTTPS_BASE ?>my-meals">Rate My Meals</a></td>
</tr>
<tr bgcolor="#5c6670">
...
<p>Thank you for placing your order. We're excited about the change Dream Dinners is making in your life. Here's to another month of easy, homemade dinners and savoring more moments with those you love.</p>
  <!--<p>Assembling with a friend is double the fun! Invite your friends to <a href="<?=HTTPS_BASE?>my-events?sid=<?=$this->sessionInfo['session_id']?>">schedule the same session</a> and join you.--> </p>
<?php } ?>

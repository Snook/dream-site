...
<table width="650" border="0" cellspacing="0" cellpadding="8">
	<tr>
		<td>
			<p>Dear <?php echo $this->customer_name ?>, </p>
			<p>Your order scheduled for <b><?php echo $this->dateTimeFormat($this->origSessionInfo['session_start'], NORMAL);?></b> has been rescheduled.</p>
			<p>The new pick up time is at <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b>.</p>

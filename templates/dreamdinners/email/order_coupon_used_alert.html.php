...
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr bgcolor="#5c6670">
		<td colspan="2" style="padding: 5px"><p align="center"><span style="color:#FFF; font-size:14pt; font-weight:bold;">Order Coupon Used</span></p></td>
	</tr>
</table>
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="8">
	<tr>
		<td><p class="sectionhead"><b>CUSTOMER INFORMATION</b></p>
			Name: <a href="<?php echo HTTPS_SERVER; ?>/main.php?page=admin_user_details&id=<?php echo $this->user->id; ?>"><?php echo $this->user->firstname; ?> <?php echo $this->user->lastname; ?></a><br />
			Email:&nbsp;<?php echo $this->customer_primary_email; ?>
			<p>&nbsp; </p>
			<p class="sectionhead"><b>Coupon Used</b></p>
			<p><?php echo $this->coupon_details->coupon_code; ?> - <?php echo $this->coupon_details->coupon_code_title; ?></p>
			<p>&nbsp; </p>

...
Your order scheduled for <?=$this->dateTimeFormat($this->origSessionInfo['session_start'], NORMAL);?> has been rescheduled.

The new pick up time is at <b><?=$this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?>.

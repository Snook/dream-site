...
<tr>
<td width="60%" align="left" style="padding: 5px"><img src="<?php echo EMAIL_IMAGES_PATH?>/email/style/dream_dinners_grey_325x75.png" alt="Dream Dinners" width="325" height="75"></td>
...
<ul>
 ...
 <!--<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
   <td width="15%" align="right"><img src="<?php echo EMAIL_IMAGES_PATH?>/email/icons/cookbook-icon.gif" alt="" width="70" height="67"></td>
   <td width="85%" align="left" valign="middle">Dinnertime stress wondering what to cook</td>
  </tr>
  <tr>
   <td width="15%" align="right"><img src="<?php echo EMAIL_IMAGES_PATH?>/email/icons/price-icon.gif" alt="" width="70" height="67"></td>
   <td width="85%" align="left" valign="middle">Unplanned, costly or unhealthy dinners out</td>
  </tr>
  <tr>
   <td width="15%" align="right"><img src="<?php echo EMAIL_IMAGES_PATH?>/email/icons/cart-icon.gif" alt="" width="70" height="67"></td>
   <td width="85%" align="left" valign="middle">Last minute trips to the grocery store to buy ingredients for dinner</td>
  </tr>
  <tr>
   <td width="15%" align="right"><img src="<?php echo EMAIL_IMAGES_PATH?>/email/icons/clock-icon.gif" alt="" width="70" height="67"></td>
   <td width="85%" align="left" valign="middle">Unnecessary hours in the kitchen cooking and cleaning</td>
  </tr>
 </table>-->

 <p><strong>Account Email Address:</strong> <?php echo $this->primary_email?></p>
<p>Please review our <a href="<?php echo HTTPS_SERVER; ?>/terms">Terms and Conditions</a> to learn more about Dream Dinners.</p>

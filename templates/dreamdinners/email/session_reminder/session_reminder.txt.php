Dream Dinners
Assembly Order Reminder

Dear <?php echo $this->DAO_user->firstname; ?>,

It's almost time to assemble your meals. We're looking forward to seeing you <?php echo $this->DAO_session->sessionStartDateTime()->format("F j, Y - g:i A"); ?> at our <?php echo $this->DAO_store->store_name; ?> location.

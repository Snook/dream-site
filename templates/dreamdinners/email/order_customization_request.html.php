...
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr bgcolor="#5c6670">
		<td colspan="2" style="padding: 5px"><p align="center"><span style="color:#FFF; font-size:14pt; font-weight:bold;">Meal Customization Request</span></p></td>
	</tr>
</table>
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="8">
	<tr>
		<td><p class="sectionhead"><b>CUSTOMER INFORMATION</b></p>
			Name:&nbsp;<?=$this->customer_name ?><br />
			Email:&nbsp;<?=$this->customer_primary_email ?>
			<p>&nbsp; </p>
			<p class="sectionhead"><b>MEAL CUSTOMIZATION REQUESTS</b></p>
			<p><?=  $this->meal_customization_string ?></p>
			<p>&nbsp; </p>

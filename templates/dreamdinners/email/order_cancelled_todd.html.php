					...
					<td>
						<p>Dear
						  ...
						  Your registration for a Taste of Dream Dinners party on <b>
								...
								<?php echo $this->sessionInfo['store_name']?>
...
<table border="0" cellpadding="4" cellspacing="0" width="604">
	<tr>
		<td colspan="2" align="center" valign="middle">Learn about Dream Dinners: <a href="<?php echo HTTPS_BASE?>how_it_works">How It Works</a> | <a href="<?php echo HTTPS_BASE?>shared_stories">Shared Stories &amp; Comments</a></td>
	</tr>
	<tr>

...
Date: <?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], FULL_MONTH_DAY_YEAR)?>
...
Avg Cost Per Serving for Dinners: $<?php echo $this->moneyFormat($this->menuInfo['cost_per_serving']) . "\n" ?>
...
<?php echo $item['qty']?>		<?php echo $item['display_title'] ?>
<?php }
} }?>
...
Phone: <?php echo $this->sessionInfo['telephone_day'] . "\n";?>
<?php } ?>

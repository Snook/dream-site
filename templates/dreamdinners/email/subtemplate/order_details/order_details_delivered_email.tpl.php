			...
			<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="15">
				<tr>
					<td valign="top">
						...
						<br />
						<strong>Order Confirmation:</strong> <a href="<?= HTTPS_BASE ?>?page=<?= $this->details_page ?>&order=<?= $this->orderInfo['id'] ?>">
				...
				<tr>
					<td>
						...
						<?php } else { ?>
							...
							<p><a href="<?=HTTPS_BASE ?>?page=my_meals">Rate your meals now &gt;</a></p>
...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td colspan="3" align="center"><p align="center">If you have questions please contact us at 360-804-2020 or via email at <a href="mailto:support@dreamdinners.com">support@dreamdinners.com</a></p></td>
	</tr>
</table>
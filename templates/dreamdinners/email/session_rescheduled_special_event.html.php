...
<td><p>Dear <?= $this->customer_name ?>, </p>
      <p>Your<i> </i>order scheduled for pick up on <b><?=$this->dateTimeFormat($this->origSessionInfo['session_start'], NORMAL);?></b> at our <b><?=$this->sessionInfo['city']?></b> location has been rescheduled.</p>
      <p>The new pick up time is <b><?=$this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b>.</p>

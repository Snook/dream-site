...
<td><p>Dear <?php echo $this->customer_name ?>, </p>
   <p>Your<i> </i>order scheduled for pick up on <b><?php echo $this->dateTimeFormat($this->origSessionInfo['session_start'], NORMAL);?></b> at our <b><?php echo $this->sessionInfo['city']?></b> location has been rescheduled.</p>
   <p>The new pick up time is <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b>.</p>

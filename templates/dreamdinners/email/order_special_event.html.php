...
<td width="300" align="right" style="padding: 5px"><a href="<?php echo HTTPS_BASE ?>my-account">My Account</a> | <a href="<?php echo HTTPS_BASE ?>my-meals">Rate My Meals</a></td>
</tr>
<tr bgcolor="#5c6670">
...
<tr>
<td><p>Thank you for placing an order with Dream Dinners. We look forward to seeing you during your scheduled pick up window.</p>
	<p>Your freshly assembled dinners will be ready for you when you arrive. Please bring a cooler or box to transport your dinners home. It is important that you arrive during your scheduled time, so we can assist you with your pick up.</p>
	<p>See you soon!</p>

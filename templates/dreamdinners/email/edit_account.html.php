...
<td width="300" align="right" style="padding: 5px"><a href="<?php echo HTTPS_BASE?>my-events?sid=<?php echo $this->sessionInfo['session_id']?>">Invite Friends</a> | <a href="<?php echo HTTPS_BASE ?>my-meals">Rate My Meals</a></td>
</tr>
<tr bgcolor="#5c6670">
...
<tr>
<td><p>Dear <?php echo $this->firstname ?>, </p>
   <p>This message is confirmation of recent changes to your account information. To view your account information, go to <a href="<?php echo HTTPS_BASE?>my-account">My Account</a></p>

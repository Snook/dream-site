...
<td><p>Dear <?= $this->firstname ?>, </p>
      <p>This message is confirmation of recent changes to your account information. To view your account information, go to <a href="<?= HTTPS_BASE?>my-account">My Account</a></p>

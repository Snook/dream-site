...
<tr>
<td><p>To <?php echo $this->sessionInfo['store_name'] ?> Staff, </p>
   <p>The payment for the order for <b><?php echo $this->customer_name ?></b> which is scheduled for <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b> at our <b><?php echo $this->sessionInfo['store_name']?>
   </b> has been declined or an error occurred during the transaction.</p>
   <p>The reason that the transaction failed or was declined : <b><?php echo $this->declinedPaymentReason?></b>.</p>

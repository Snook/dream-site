	...
	<table class="mobile" role="presentation" width="600"  border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td style="padding:20px 20px 10px 20px;">
				<p>We are sorry to see that Meal Prep+ did not work for you. Your membership has now been canceled, because you have missed placing a standard consecutive order within your membership period.</p>
				<p>Although Meal Prep+ was not a good fit for your family at this time, we are still here to help provide easy, prepped meals when you need them. We hope to see you soon. </p>
				<p>If you feel your membership has been canceled by mistake, please contact us at <?php echo $this->store->telephone_day; ?> or via email by replying.</p>
		</tr>
		<tr>

		...
		<tr>
		  <td style="padding:10px 20px 10px 20px;">
			...
			<p>By signing up for Meal Prep+, you will receive 10% off all Dream Dinners meals, sides & sweets for the next 6 months. Plus, you have access to shop from the freezer all month long. Need an extra dessert, a few more meals or even just a side or two? You are covered.</p>
			  <p>On average, our guests save over $100 during their membership period. Now pat yourself on the back for being such a savvy shopper. <a href="https://dreamdinners.com/meal_prep_plus">Click here for additional information</a> on your new Meal Prep+ membership or contact your local Dream Dinners store.</p>
		</tr>
		<tr>
			<td><hr width="100%" size="1" noshade color="#666666" style="color: #666; height:1px; border: 0;"></td>
		</tr>
		<tr>
			<td style="padding:20px 20px 10px 20px;">6-Month Meal Prep+ Membership: $<?php echo $this->order_details->grand_total; ?></td>
		</tr>
		<tr>
			<td style="padding:10px 20px 10px 20px;">Membership Purchase Date: <?php echo CTemplate::dateTimeFormat($this->user->membershipData['enrollment_date'], VERBOSE); ?></td>
		</tr>
		<tr>
			<td style="padding:10px 20px 20px 20px;">Last Membership Month: <?php echo $this->user->membershipData['completion_month']; ?></td>
		</tr>
		<tr>
			<td><hr width="100%" size="1" noshade color="#666666" style="color: #666; height:1px; border: 0;"></td>
		</tr>
		<tr>
			<td align="center" style="padding:20px 20px 20px 20px;">
				...
				<p align="center">
					...
					<?php echo $this->order_details->storeObj->address_line1 ?> <?php echo !empty( $this->order_details->storeObj->address_line2 ) ? $this->order_details->storeObj->address_line2 : ''; ?><br />

    ...
    <tr>
     ...
     <table role="presentation" width="100%" align="center" cellpadding="2">
      <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
       <td align="left" valign="top"><?php echo $thisCard['card_image']?>
				 <p>&nbsp;</p>
...
<?php if ($thisCard['media_type'] == 'PHYSICAL') { ?>
        ...
        <?php } ?>
        <strong>Card Design:</strong> <?php echo $thisCard['design_title']?><br />
        <strong>Amount:</strong> $<?php echo $thisCard['card_amount']?><br />
        <strong>To:</strong> <?php echo $thisCard['to_name']?><br />
        <strong>From:</strong> <?php echo $thisCard['from_name']?><br />
        <strong>Message:</strong> <?php echo $thisCard['message_text']?><br />
        <?php if ($thisCard['media_type'] == 'VIRTUAL') { ?>
        <strong>Recipient Email Address:</strong> <?php echo $thisCard['recipient_email']?><br />
        <strong>Resend eGift Card Email:</strong> &nbsp;<a href="<?php echo HTTPS_BASE?>/resend_egift?oid=<?php echo $thisCard['confirm_id']?>">Click here to resend</a>
        <p>&nbsp;</p>
        <?php } else { ?>
        <strong>Recipient Name:</strong> <?php echo $thisCard['ship_to_name']?><br />
        <strong>Recipient Address:</strong> <br />
			  <?php echo $thisCard['shipping_address_1']?> <br />
			  <?php if (!empty($thisCard['shipping_address_2'])) { ?>
			  <?php echo $thisCard['shipping_address_2']?><br />
        <?php } ?>
        <?php echo $thisCard['shipping_city']?>, <?php echo $thisCard['shipping_state']?> <?php echo $thisCard['shipping_zip']?><p>&nbsp;</p>
        </td>
      </tr>
        <?php } ?>
     </table>
  ...
  <table role="presentation" width="100%" align="center" cellpadding="2">
   ...
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    ...
    <td width="50%" align="left" valign="middle"><?php echo $this->payment_card_type?></td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    <td width="50%" align="right" valign="middle"><strong>Last 4 digits:</strong></td>
    <td width="50%" align="left" valign="middle"><?php echo $this->credit_card_number?></td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    <td align="right" valign="middle"><strong>Amount:</strong></td>
    <td align="left" valign="middle">$<?php echo $this->charged_amount?></td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    <td align="right" valign="middle"><strong>Date of Purchase:</strong></td>
    <td align="left" valign="middle"><?php echo $this->date_of_purchase?></td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    <td width="50%" align="right" valign="middle"><strong>Billing Name:</strong></td>
    <td width="50%" align="left" valign="middle"><?php echo $this->billing_name?></td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    <td align="right" valign="top"><strong>Billing Address:</strong></td>
    <td align="left" valign="middle"><?php echo $this->billing_address?><br />
     <?php echo $this->billing_zip?>
		</td>
   </tr>
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
   ...
   <tr style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
    ...
    <td align="left" valign="middle"><?php echo $this->billing_email?></td>
   </tr>
  </table>
...
Note: $2 shipping/service fee added each Traditional Gift Card ordered.</em></p>
   <p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;"><strong>Have questions?</strong> To view the complete Gift Card Policies &amp; Terms online or if you have questions regarding your Gift Card or Customer Service options please visit <a href="<?php echo HTTPS_SERVER ?>/terms">dreamdinners.com</a></p>
   <p>&nbsp; </p>
</td>
</tr>
</table>

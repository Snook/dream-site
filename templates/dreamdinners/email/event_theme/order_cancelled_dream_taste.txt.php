...
Your order for the Dream Dinners Event on <?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], VERBOSE);?> at our <?php echo $this->sessionInfo['store_name']?> location has been canceled.

If you have any questions or concerns regarding this cancellation please contact the event host or the <?php echo $this->sessionInfo['store_name']?> location.

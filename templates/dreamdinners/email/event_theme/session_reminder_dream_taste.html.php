...
<table width="100%" border="0" cellspacing="0" cellpadding="8">
	<tr>
		<td>
			<p>Dear <?php echo $this->DAO_user->firstname; ?>,<br />
			  We are excited to meet you. We're looking forward to seeing you <strong><?php echo $this->DAO_session->sessionStartDateTime()->format("F j, Y - g:i A"); ?></strong> at our <strong><?php echo $this->DAO_store->store_name; ?></strong> location. Be ready to have a great time and meet new friends.</p>
			...
			<p>If you have any questions regarding this party please <a href="<?php echo HTTPS_BASE; ?>locations">contact the store hosting this party.</a></p>

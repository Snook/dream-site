...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tbody>
    <tr>
      <td><p>There are limited spaces available, and this offer is only available for guests of this event. Use the link below to reserve your spot today! <a href="<?php echo HTTPS_SERVER; ?>/how-it-works" target="_blank">Learn more about Dream Dinners.</a></p></td>
    </tr>
  </tbody>
</table>

...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="0" align="left">
	...
	<tr bgcolor="#FFFFFF">
		<td style="padding:20px;"><p align="center"><span class="title">Celebrate the season with our Christmas Brunch Trial Offer.</span></p>
			<p align="center">For only $<?php echo $this->session['dream_taste_price']; ?>, Dream Dinners has you covered for both your Christmas morning brunch and the week that follows.</p>
			<p align="center">During this exclusive pick up event, you will receive a Breakfast Frittata, Seasonal French Toast Bake and Country Potatoes plus three medium dinners from our delicious menu. Your Christmas Brunch comes in our family-size that serves 4-6 people.</p>

...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="0" align="left">
	...
	<tr bgcolor="#FFFFFF">
		<td style="padding:20px;"><p align="center"><span class="title">Celebrate the season with our Thanksgiving Trial Offer.</span></p>
			<p align="center">For only $<?php echo $this->session['dream_taste_price']; ?>, Dream Dinners has you covered for both your holiday and the week that follows.</p>
			<p align="center">During this exclusive pick up event, you will receive our Holiday Roasted Turkey, Holiday Mashed Potatoes, Holiday Savory Stuffing, and Holiday Green Bean Casserole plus three medium dinners from our delicious menu.</p>
			<p align="center">Our offer is only for guests of this event, and availability is limited. Use the link below to place your order today!</p>

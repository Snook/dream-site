...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="0" align="left">
 ...
 <tbody>
  <tr>
   ...
   <td><p>Plus, you get our exclusive no-bake mini cheesecake kit. Only available at our Meal Prep Workshops, these fun single-serving desserts are a great way to treat yourself after a long day. Use the link below to <a href="<?php echo $this->referral_link; ?>">so reserve your spot today.</a></p></td>
  </tr>
 </tbody>
</table>

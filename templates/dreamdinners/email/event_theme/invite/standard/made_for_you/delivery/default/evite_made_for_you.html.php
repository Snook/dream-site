...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="0" align="left">
	...
	<tr bgcolor="#FFFFFF">
		<td><img src="<?php echo EMAIL_IMAGES_PATH; ?>/email/event_theme/standard/made_for_you/delivery/<?php echo $this->session['menu_directory']; ?>/graphic.jpg" alt="Meal Prep Workshop Menu" /></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td style="padding:20px;"><p align="center"><span class="title">You have been invited to try our Home Delivery service</span></p>
			<p align="center">

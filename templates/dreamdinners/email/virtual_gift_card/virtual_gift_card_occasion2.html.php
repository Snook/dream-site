...
<table role="presentation" width="500" border="0" align="center" cellpadding="5" cellspacing="0">
 <tr>
  <td align="center"><p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">You've received a $<?php echo $this->card_amount?> Dream Dinners Gift Card.</p></td>
 </tr>
	<tr>
...
<table role="presentation" width="500" align="center" style="border: 1px solid #CCCCCC;">
 ...
 <tr>
  <td align="center"><img src="<?php echo EMAIL_IMAGES_PATH?>/gift_cards/egift-card-occasion-2-500x317.png" width="500" height="317" alt="Homemade, Made Easy"></td>
 </tr>
</table>
<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="6">
 <tr>
  <td width="50%" align="left" valign="top"><p><span style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #444444;">Gift Card Number:</span><br />
   <span style="font-family:Arial, Helvetica, sans-serif; font-size: 18px; color: #444444;"><?php echo $this->account_number?></span><br />
   <a href="<?php echo HTTPS_SERVER?>/session-menu"><img src="<?php echo EMAIL_IMAGES_PATH?>/gift_cards/view-menu-button-olive-150x45.gif" alt="View Menu" width="150" height="45" border="0"></a></p></td>
  <td width="50%" align="left" valign="top"><span style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #444444;">Gift Card Amount:</span><br />
   <span style="font-family:Arial, Helvetica, sans-serif; font-size: 36px; color: #444444; font-weight:bold;">$<?php echo $this->card_amount?></span></td>
 </tr>
 <tr>
  <td align="left" valign="top" colspan="2"><p><span style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #444444;">To: </span><span style="font-family:Arial, Helvetica, sans-serif; font-size: 18px; color: #444444; font-weight:bold;"><?php echo $this->to_name?></span></p>
  <p><span style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #444444;">From:</span> <span style="font-family:Arial, Helvetica, sans-serif; font-size: 18px; color: #444444; font-weight:bold;"><?php echo $this->from_name?></span></p>
  <p><span style="font-family:Arial, Helvetica, sans-serif; font-size: 14px; color: #444444;"><?php echo $this->message_text?></span></p></td>
 </tr>
</table></td>
 </tr>
</table>

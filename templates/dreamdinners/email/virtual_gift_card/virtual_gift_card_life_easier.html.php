...
<table role="presentation" width="500" border="0" align="center" cellpadding="5" cellspacing="0">
	<tr>
    <td align="center"><p style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">You've received a $<?=$this->card_amount?> Dream Dinners Gift Card.</p></td>
  </tr>
	<tr>
...
<table role="presentation" width="500" align="center" style="border: 1px solid #CCCCCC;">
  ...
  <tr>
    <td align="center"><img src="<?=EMAIL_IMAGES_PATH?>/gift_cards/egift-card-occasion-1-500x317.png" width="500" height="317" alt="Homemade, Made Easy"></td>
  </tr>
</table>
<table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="6">
  <tr>
    <td width="50%" align="left" valign="top"><p><span style="font-family:Arial, Helvetica, sans-serif; font-size: 12px; color: #444444;">Gift Card Number:</span><br />
      ...
      <a href="<?=HTTPS_SERVER?>/?page=session_menu"><img src="<?=EMAIL_IMAGES_PATH?>/gift_cards/view-menu-button-olive-150x45.gif" alt="View Menu" width="150" height="45" border="0"></a></p></td>

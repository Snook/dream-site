...
<td><p>Dear <?php echo $this->customer_name ?>, </p>
   <p>Your order scheduled for delivery on <b><?php echo $this->dateTimeFormat($this->origSessionInfo['session_start'], NORMAL);?></b> has been rescheduled.</p>
   <p>The new delivery window starts at <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b>.</p>

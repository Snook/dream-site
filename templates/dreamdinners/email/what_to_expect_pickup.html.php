...
<table role="presentation" width="600" align="center">
	<tr>
		<td><img src="<?php echo EMAIL_IMAGES_PATH?>/misc/in-a-snap-chicken-tenders-collage-600x300.jpg" width="600" height="300" alt="Dream Dinners"></td>
	</tr>
</table>
<table role="presentation" width="600" border="0" align="center" cellpadding="20" cellspacing="0">
	<tr>
		<td><p style="font-family:Arial, Helvetica, sans-serif; font-size: 24px; color: #444444;"><strong>What to Expect</strong></p>
			<p style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #444444;">Your Dream Dinners will be ready for pick up soon! We are so excited to help you with ready-to-cook meals that are easy and delicious. Here is what to expect when you arrive at your pick up.</p>
			<ul style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #444444;">
				<li>Your meals will be ready on <b><?php echo $this->DAO_booking->DAO_session->sessionStartDateTime()->format("F j, Y - g:i A"); ?> to <?php echo $this->DAO_booking->DAO_session->sessionEndDateTime()->format("g:i A"); ?></b>.</li>
				<li><strong>Once you get home, place 3-4 meals in your fridge to thaw & enjoy this week.</strong> Add the extras to your freezer to enjoy next week. </li>

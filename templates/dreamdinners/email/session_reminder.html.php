...
<td width="40%" align="right" style="padding: 5px"><a href="<?=HTTPS_SERVER?>/main.php?page=my_events&sid=<?=$this->session_id?>"><span style="color: #FFF;">Invite Friends</span></a><span style="color: #FFF;"> | </span><a href="<?=HTTPS_BASE ?>main.php?page=my_meals"><span style="color: #FFF;">Rate My Meals</span></a></td>
</tr>
<tr bgcolor="#663300">

	...
	<tr>
		<td><p style="font-family:Arial, Helvetica, sans-serif; font-size: 24px; color: #444444;"><strong>What to Expect</strong></p>
				...
				<ul style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #444444;">
				  <li>Your meals will be delivered on <b><?php echo $this->DAO_session->sessionStartDateTime()->format("F j, Y - g:i A"); ?> to <?php echo $this->DAO_session->sessionEndDateTime()->format("g:i A"); ?></b>. You will be notified when they are on the way.</li>

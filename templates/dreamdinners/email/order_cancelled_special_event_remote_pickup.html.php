...
<table role="presentation" width="650" border="0" cellspacing="0" cellpadding="8">
	<tr>
		<td>
			...
			<p>Your Home Delivery order, scheduled for <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b> at our <b><?php echo $this->sessionInfo['store_name']?></b> location has been canceled.</p>

...
<td><p>Dear <?php echo $this->customer_name ?>, </p>
   <p>Your order for a session scheduled for <b><?php echo $this->dateTimeFormat($this->origSessionInfo['session_start'], NORMAL);?></b> at our <b><?php echo $this->sessionInfo['city']?></b> location has been rescheduled.</p>
   <p>The new session time is <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b>.</p>

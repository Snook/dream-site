...
<tr bgcolor="#5c6670">
  <td colspan="2" style="padding: 5px"><p align="center"><span style="color:#FFF; font-size:14pt; font-weight:bold;">Order Modification</span></p></td>
</tr>
</table>
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="8">
<tr>
<td>
<p>On <?php echo CTemplate::dateTimeFormat($this->orderInfo['timestamp_updated'], VERBOSE)?> we made the requested changes to your original order which may include:  different menu items, items added from the Sides &amp; Sweets Freezer, quantity adjustments, or payment changes.  Please view these revisions below to confirm they're as you intended.</p>
<p>Thank you for your order and sharing our dream of savoring life's moments one dinner at a time.</p>
<p>Sincerely,<br />

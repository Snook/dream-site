...
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="300" align="right" style="padding: 5px"><a href="<?=HTTPS_BASE ?>?page=my_events">My Events</a> | <a href="<?=HTTPS_BASE ?>?page=my_account">My Account</a></td>
	</tr>
	<tr bgcolor="#5c6670">
		<td colspan="2" style="padding: 5px"><p align="center"><span style="color:#FFF; font-size:14pt; font-weight:bold;">Your Meal Prep Workshop is Scheduled!</span></p></td>
	</tr>
</table>
<table role="presentation" width="650"  border="0" cellspacing="0" cellpadding="8">
	<tr>
		<td>
			<p>You can now share Dream Dinners with your friends and family by inviting them to join you for food and fun. Below are the details of your private in-store event and, most importantly, the link for everyone to use to RSVP.</p>
			<p>Visit the <a href="<?=HTTPS_BASE ?>?page=my_events">My Events page</a> in your Dream Dinners account to get access to our easy to use sharing tools.</p>
			...
			<table role="presentation" width="90%"  border="0" align="center" cellpadding="4" cellspacing="3">
				...
				<tr>
					...
					<td align="left" valign="middle"><a href="<?=HTTPS_BASE ?>?page=my_events">Login to start sharing!</a></td>
				</tr>
			</table>
		</td>
	</tr>

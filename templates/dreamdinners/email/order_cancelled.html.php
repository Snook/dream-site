...
<td><p>Dear <?= $this->customer_name ?>, </p>
      <p>Your order for a session scheduled for <b><?=$this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b> at our <b><?=$this->sessionInfo['city']?></b> location has been canceled.</p>

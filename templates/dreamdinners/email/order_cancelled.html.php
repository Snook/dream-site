...
<td><p>Dear <?php echo $this->customer_name ?>, </p>
   <p>Your order for a session scheduled for <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b> at our <b><?php echo $this->sessionInfo['city']?></b> location has been canceled.</p>

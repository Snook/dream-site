	...
	<tr>
		<td style="padding:10px 15px 5px 15px;">
			...
			<p>Thank you for testing <?php echo $this->recipe_name; ?>, one of our new Dream Dinners recipes. The opinions of our guests are so important to us, especially when we are developing new
				recipes for the menu. Please prepare the dinner for your family and give us your honest feedback in your <a href="<?php echo HTTPS_BASE; ?>main.php?page=my_surveys">My Test Recipes</a> section of your Dream Dinners account.</p>

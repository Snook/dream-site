	...
	<tr>
		<td><p style="font-family:Arial, Helvetica, sans-serif; font-size: 24px; color: #444444;"><strong>What to Expect</strong></p>
			...
			<ul style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #444444;">
				<li>You will be emailed a tracking number when they are on their way.</li>
				<li><strong>Once your meals arrive, place your meals in the fridge to enjoy this week.</strong> Your meals may arrive partially frozen or thawed but will still be cold to the touch.
					<ul>
						<li>Looking to save a few of your meals for next week? If they are still partially frozen, you can place them back in the freezer to refreeze them once.</li>
					</ul>
				</li>
				<li><strong>Dinners still frozen and you want to cook one when they arrive?</strong> Use these quick thaw tips.
					<ul>
			...
			<p style="font-family:Arial, Helvetica, sans-serif; font-size: 16px; color: #444444;">Enjoy your dinners with your family! When you need more meals, place another order at <a href"https://dreamdinners.com/shipping">DreamDinners.com</a></p>.
			<hr>

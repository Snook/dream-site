...
<tr>
 <td><img src="<?php echo EMAIL_IMAGES_PATH; ?>/email/platepoints/platepoints-generic-header.png" alt="PLATEPOINTS Executive Chef" border="0" width="550" height="150" /></td>
</tr>
<tr>
<td style="padding:10px 15px 5px 15px;"><p>
<img src="<?php echo EMAIL_IMAGES_PATH; ?>/email/platepoints/badge-executive_chef-119x119.png" align="right" alt="PLATEPOINTS Executive Chef" border="0" width="119" height="119" />
 <span class="subheads">Chef Milestone: Executive Chef</span><br />
...
<span class="subheads">Available Dinner Dollars: $<?php echo CTemplate::moneyFormat($this->total_available_credit);?></span></p>
 <p>Congratulations <?php echo $this->userObj->firstname;?>!<br />
  You grilled your way to Dream Dinners Executive Chef and we want to celebrate you for gathering your family around the table for homemade meals. </p>
  <?php if (!$this->user_is_preferred) { ?>
  <p>For your accomplishments, you have earned a thermal cooler bag*. Bring this voucher/email in to your next session to claim your prize.<br /><img src="<?php echo EMAIL_IMAGES_PATH; ?>/email/platepoints/executive-chef-voucher.gif" alt="Perk Voucher" border="0" width="463" height="135" /></p>
 <p> As an Executive Chef, you receive 10 Bonus Dinner Dollars** and you will continue to earn 4x PLATEPOINTS when you sign up in-store every month. </p>
 <p>Now that you are an Executive Chef, you get to wear our blue Executive Chef apron during your future visits, to distinguish you during your session.</p>

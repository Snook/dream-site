...
Your Home Delivery order scheduled on <?=$this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?> at our <?=$this->sessionInfo['store_name']?> location has been canceled.

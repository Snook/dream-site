...
<table width="650"  border="0" cellspacing="0" cellpadding="0">
	<tr bgcolor="#afbd21">
		...
		<td width="300" align="right" style="padding: 5px"><a href="<?php echo HTTPS_BASE; ?>?page=my_account"><span style="color: #FFF;">My Account</span></a><span style="color: #FFF;"> | </span><a href="<?=HTTPS_BASE ?>?page=my_meals"><span style="color: #FFF;">Rate My Meals</span></a></td>
	</tr>
</table>

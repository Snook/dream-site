...
<td><p>Dear <?php echo $this->customer_name ?>, </p>
   <p>Your order, scheduled to be picked up <b><?php echo $this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b> at our <b><?php echo $this->sessionInfo['store_name']?>

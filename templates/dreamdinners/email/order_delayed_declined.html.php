...
<td><p>Dear <?= $this->customer_name ?>, </p>
      <p>Your payment for order scheduled for <b><?=$this->dateTimeFormat($this->sessionInfo['session_start'], NORMAL);?></b> at our <b><?=$this->sessionInfo['store_name']?>
      </b> has been declined.</p>
      <p>The reason we are told that the payment was declined is: <?=$this->declinedPaymentReason?></p>

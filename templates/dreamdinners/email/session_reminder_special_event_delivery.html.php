...
<p>Dear <?= $this->firstname ?>, <br /><br />
  Your delivery is coming up soon. We're looking forward to seeing you during your home delivery window on <b><?=$this->dateTimeFormat($this->session_start, NORMAL);?> to <?= date("g:i A", strtotime($this->session_end))?></b>.</p>
...
<li><a href="<?=HTTPS_BASE?>session-menu">Place your next order to reserve your preferred delivery time.</a></li>
</ol>

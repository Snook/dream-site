			...
			<div class="container-fluid my-5">
				...
				<div class="row">
					<div class="col-md-6 text-center p-5 my-2">
						...
						<p class="mb-4">We deliver prepped, family-style dinners to your front porch via FedEX.<br /><a href="/main.php?page=locations" class="btn btn-lg btn-green-dark mt-3">Check Shipping Areas</a></p>
					</div>
					<div class="col-md-6 text-center p-5 my-2">
						...
						<p class="mb-4">Show your love with delicious, easy meals for them to enjoy.<br /><a href="/main.php?page=locations" class="btn btn-lg btn-green-dark mt-3">Check Gifting Areas</a></p>
					</div>
				</div>
			</div>
		</section>-->

...
<?php $this->assign('page_title', 'Spin to Win August 2023');?>
	...
	<header class="container my-5">
		<div class="row">
			...
			<div class="col-12 col-sm-6 p-sm-0 order-1 order-sm-2 mb-4 mb-sm-0 text-center">
				<h1>Summer Spin to Win August</h1>
			</div>
	...
	<main role="main">
		<section>
			<div class="container text-center">
				...
				<p class="text-center font-weight-bold">This promotion ends August 31, 2023. Each guest gets 2 chances to view the prize wheel for an entry.</p>

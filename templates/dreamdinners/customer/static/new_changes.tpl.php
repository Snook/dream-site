			...
			<div class="container-fluid my-5">
				<div class="row hero-double">
					<div class="col-md-6 text-left p-5 my-5">
						...
						<p class="text-uppercase mb-4">New lower minimums and additional flexibility to meet your dinnertime needs.</p>
				...
				<div class="row my-2 mt-5">
					<div class="col">
						<div class="card-group">
							...
							<div class="card border-0 mx-1 text-left">
								<div class="card-body">
									<h5 class="card-title">Come More Than Once</h5>
									<p class="card-text">Order throughout the month.</p>
								</div>
							</div>
							<div class="card border-0 mx-1 text-center">

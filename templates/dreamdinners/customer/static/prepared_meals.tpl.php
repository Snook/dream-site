<?php $this->assign('page_title', 'Prepared Meals');?>
<?php $this->assign('page_description','Dream Dinners, the Original Meal Kit, brings easy, prepared meals to families in your community. Our delicious dinners are prepped with quality ingredients in our local assembly kitchens.'); ?>
	...
	<main role="main">
        ...
        <section>
			<div class="container-fluid">
				<div class="row my-5 p-5 bg-image-prepared-meals">
			...
			<div class="container">
				<div class="row my-5">
					<div class="col-md-5 mb-6">
						<div>
							<img src="<?php echo IMAGES_PATH; ?>/landing_pages/mom-making-pot-pies-pan-450x300.webp" alt="making pot pies" class="img-fluid mb-4" />
						</div>
					</div>
					<div class="col-md-7 text-left">
					  <h2><strong>Here’s how prepared meals from Dream Dinners stands out:</strong></h2>
						<br>&nbsp;
                      <ul>
				...
				<div class="row my-4">
					<div class="col">
						<div class="card-group text-center">
							...
							<div class="card border-0 mx-1">
								<img src="<?php echo IMAGES_PATH; ?>/landing_pages/pork-tenderloin-wellington-circle-458x344.webp" alt="Pork Tenderloin Wellington" class="img-fluid" />
								<div class="card-body">
									<p class="card-text">Pork Tenderloin Wellington</p>
								</div>
							</div>
							<div class="card border-0 mx-1">
								<img src="<?php echo IMAGES_PATH; ?>/landing_pages/chateau-chicken-circle-458x344.webp" alt="Chateau Chickenwith Almond Butter Sauce" class="img-fluid" />
								<div class="card-body">
									<p class="card-text">Chateau Chicken with Almond Butter Sauce</p>
								</div>
							</div>
							<div class="card border-0 mx-1">

<?php $this->assign('page_title', 'Meal Prep - Homemade Dinners');?>
...
<?php $this->assign('page_keywords','meal prep, prepped dinners, homemade dinner, homemade meals, prepared meals, dinner solution, meal assembly, dinner preparation'); ?>
				...
				<div class="row my-4">
					<div class="col">
						<div class="card-group text-center">
							...
							<div class="card border-0 mx-1">
								<img src="<?php echo IMAGES_PATH; ?>/how_it_works/assemble-your-meals-458x344.jpg" alt="assemble dinners" class="img-fluid" />
								<div class="card-body">
									<p class="card-text">Step 2</p>
									<h5 class="card-title">Meals are Prepped</h5>
				...
				<div class="row">
					<div class="col">
						<div class="text-center text-white">
							<h2 class="my-4">Three Ways to Serve You</h2>

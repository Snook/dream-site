			...
			<div class="container faq">
				<div class="row">
                    ...
                    <h2 class="font-weight-semi-bold text-uppercase font-size-medium mb-4 text-center">What can we help you with?</h2>
						<p class="mb-3 text-center">Browse our list of help topics outlined below. If you still have questions and would like to speak with a team member at your local store, click <a href="/main.php?page=locations">Locations</a> to find the direct contact information for the store that you are interested in. Additionally, you can contact our home office from our <a href="main.php?static=contact_us">Contact Us page</a> for website support or guest services.</p>

								...
								<div class="col">
									<div class="collapse multi-collapse" id="multiCollapseCalifornia" data-parent="#accordion-CL">
										<div class="card card-body">
											<?php include $this->loadTemplate('customer/static/subtemplate/chickfila/cfa_california.tpl.php'); ?>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col">
									<div class="collapse multi-collapse" id="multiCollapseGeorgia" data-parent="#accordion-CL">
										<div class="card card-body">
											<?php include $this->loadTemplate('customer/static/subtemplate/chickfila/cfa_georgia.tpl.php'); ?>
										</div>
									</div>
								</div>
							</div>

			...
			<div class="container">
				<div class="row my-5">
					...
					<div class="col-md-6 text-left">
						...
						<a href="/session-menu" class="btn btn-primary btn-block mb-3 start-intro-offer">Find a Location &amp; View Menu</a>
					</div>
				</div>
			</div>
					...
					<div class="col">
						<div class="card-group text-center">
							<div class="card border-0 mx-1">
								<a href="/session-menu" class="start-intro-offer"><img src="<?php echo IMAGES_PATH; ?>/landing_pages/parmesan-herb-crusted-chicken-458x344.jpg" alt="Parmesan Herb Crusted Chicken" class="img-fluid" /></a>
							</div>
							<div class="card border-0 mx-1">
								<a href="/session-menu" class="start-intro-offer"><img src="<?php echo IMAGES_PATH; ?>/landing_pages/chicken-shrimp-carbonara-458x344.jpg" alt="Chicken and Shrimp Carbonara" class="img-fluid" /></a>
							</div>
							<div class="card border-0 mx-1">
								<a href="/session-menu" class="start-intro-offer"><img src="<?php echo IMAGES_PATH; ?>/landing_pages/mini-turkey-meatloaves-458x344.jpg" alt="MINI TURKEY MEATLOAVES WITH BACON RANCH GREEN BEANS" class="img-fluid" /></a>
							</div>
							<div class="card border-0 mx-1">
								<a href="/session-menu" class="start-intro-offer"><img src="<?php echo IMAGES_PATH; ?>/landing_pages/thai-peanut-chicken-458x344.jpg" alt="THAI PEANUT CHICKEN WITH JASMINE RICE" class="img-fluid" /></a>
							</div>
						</div>
					</div>
				</div>

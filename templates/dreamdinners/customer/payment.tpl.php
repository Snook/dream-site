		...
		<div class="row">
			<div class="col-6 col-sm-3 p-0 order-2 order-sm-1">
				<?php if (!empty($this->cart_info['cart_info_array']['direct_invite'])) { ?>
					<a href="/main.php?page=session" class="btn btn-primary"><span class="pr-2">&#10094;</span> Change Session</a>
				<?php } else { ?>
					<a href="/main.php?page=checkout" class="btn btn-primary"><span class="pr-2">&#10094;</span> Make Changes</a>
				<?php } ?>
			</div>
			<div class="col-12 col-sm-6 p-sm-0 order-1 order-sm-2 mb-4 mb-sm-0 text-center">
				<h1>Provide <span class="text-green font-weight-semi-bold">payment</span> information</h1>
			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						...
						{
							include $this->loadTemplate('customer/subtemplate/payment_form/payment_form.tpl.php');
						}
						else
						{

<?php $this->assign('page_title', 'Workshop Promotions');?>
<?php $this->assign('page_description','Get instructions on promotional items you receive at workshops.'); ?>
<?php $this->assign('page_keywords','seasonal gift, instructions'); ?>
<?php include $this->loadTemplate('customer/subtemplate/page_header.tpl.php'); ?>
	...
	<header class="container my-5">
		<div class="row">
			...
			<div class="col-12 col-sm-6 p-sm-0 order-1 order-sm-2 mb-4 mb-sm-0 text-center">
				<h1>Meal Prep Workshop Promotions</h1>
			</div>
	...
	<main role="main">
		<section>
			<div class="container">
				<img src="<?php echo IMAGES_PATH; ?>/events_programs/campfire-cobbler-trio-1400x400.webp" alt="Campfire Cobbler Trio" class="img-fluid mb-3" />
				<h2 class="text-center"><strong>Campfire Cobbler Trio Recipes</strong></h2>
						 <!--<p class="text-center">Share pictures with us in the <a href="https://www.facebook.com/groups/DreamDinnersCommunityGroup" target="_blank">Dream Dinners Community Group</a> on Facebook!</p> -->
				<div class="row my-5">
					<div class="col-md-8 text-left">
						<!-- Recipe 1 -->
						<h3>Oatmeal Cookie Peach Campfire Cobbler</h3>
                      	<p><strong>Ingredients:</strong> Frozen peach slices (3 cups), lemon juice (2 tsp), brown sugar (1/2 cup plus 1 tbsp, divided), flour (1/4 cup), cinnamon (1/4 tsp), butter (2 tbsp), oats (1/8 cup), kosher salt (1/4 tsp), frozen biscuit dough balls (x3).</p>
						<p><strong>Instructions:</strong> Combine peaches, lemon juice, brown sugar (1/2 cup), flour, and cinnamon in a small bowl; stir to combine, then set aside. To create topping mixture, combine butter, oats,remaining brown sugar (1 Tbsp), and salt in another small bowl, breaking down the butter into pebble-size pieces.Preheat grill, outdoor fire, or oven to approximately 350°F. Spray a cast-iron skillet with nonstick spray, then evenly spread the peach mixture on the bottom of the skillet. Tear biscuits in half and place evenly over fruit mixture. Sprinkle topping mixture over biscuits and filling. Cook cobbler for 25-30 minutes. If cooking on a grill, leave over indirect heat and close the grill lid. If over a fire, cover the skillet with foil for 20 minutes and finish cooking uncovered for the last 5-10 minutes. Enjoy!</p>

						<br>

						<!-- Recipe 2 -->
						<h3>Caramel Apple Campfire Cobbler</h3>
                      	<p><strong>Ingredients:</strong> Frozen apple slices (3 cups), lemon juice (2 tsp), sugar (1/4 cup), flour (1/4 cup plus 1/8 cup, divided), cinnamon (1/4 tsp), butter (2 tbsp), caramel sauce (1/4 cup), brown sugar (1 Tbsp), kosher salt (1/4 tsp), frozen biscuit dough balls (x3).</p>

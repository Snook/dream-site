								...
								<div class="col">
									<div class="collapse multi-collapse" id="multiCollapseKansas" data-parent="#accordion-GL">
										<div class="card card-body">
											<?php include $this->loadTemplate('customer/subtemplate/corporate_crate/garmin/garmin_kansas.tpl.php'); ?>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col">
									<div class="collapse multi-collapse" id="multiCollapseOregon" data-parent="#accordion-GL">
										<div class="card card-body">
											<?php include $this->loadTemplate('customer/subtemplate/corporate_crate/garmin/garmin_oregon.tpl.php'); ?>
										</div>
									</div>
								</div>
							</div>

								...
								<tr>
									<?php if ($component_count == 1) { ?>
										...
										<td rowspan="<?php echo count($recipe['component']); ?>">
											...
											<?php if ($recipe['info']['flag_crockpot']) { ?><li><i class="font-size-medium-small dd-icon icon-instant-pot text-gray-dark" data-toggle="tooltip" data-placement="top" title="Crock-Pot Option"></i></li><?php } ?>

		...
		<section>
			<div class="container">
				<div class="row my-5">
					<div class="col-md-5 mb-6">
						<div>
							<img src="<?php echo IMAGES_PATH; ?>/landing_pages/chicken-mirabella-family-circle-458x344.webp" alt="Chicken Mirabella" class="img-fluid mb-3" />
						</div>
					</div>
					<div class="col-md-7 text-left">
						<h3>Meal of the Month<br><strong>Chicken Mirabella with Linguine</strong></h3>
						<p>This meal helps fight hunger at home and abroad. For each Chicken Mirabella with Linguine sold in November, $1 will be donated to the Dream Dinners Foundation to support Breast Cancer Research.</p>
						<p class="my-3"><a href="/locations" class="btn btn-lg btn-green">ORDER NOW</a></p>
					</div>
				</div>
			</div>

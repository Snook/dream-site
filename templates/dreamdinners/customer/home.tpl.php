						...
						<div class="tab-content" id="">
							<div class="tab-pane fade show active" id="convenient" role="tabpanel" aria-labelledby="convenient-tab">
								...
								<!--<div class="col text-center">
									<a href="/main.php?static=convenience" class="btn btn-primary btn-block">Learn More</a>
								</div>-->
							</div>
							<!-- end first tab -->
							...
							<div class="tab-pane fade" id="flexible" role="tabpanel" aria-labelledby="flexible-tab">
								...
								<!--<div class="col text-center">
									<a href="/main.php?static=flexibility" class="btn btn-primary btn-block">Learn More</a>
								</div>-->
							</div>
							<!-- end second tab -->
							...
							<div class="tab-pane fade" id="quality" role="tabpanel" aria-labelledby="quality-tab">
								...
								<!--<div class="col text-center">
									<a href="/main.php?static=quality" class="btn btn-primary btn-block">Learn More</a>
								</div>-->
							...
							<div class="tab-pane fade" id="easy" role="tabpanel" aria-labelledby="easy-tab">
								...
								<!--<div class="col text-center">
									<a href="/main.php?static=ease" class="btn btn-primary btn-block">Learn More</a>
								</div>-->
							</div>
							<!-- end fourth tab -->
						</div>
			...
			<div class="container-fluid my-5">
				<div class="row px-2 px-lg-5 py-5 bg-light">
					<div class="col-lg-8 offset-lg-2 text-center">
						...
						<div class="row my-2">
							<div class="col text-center">
								<a href="/main.php?page=locations" class="btn btn-primary btn-block">GET COOKING</a>
							</div>
						</div>
					</div>
				</div>

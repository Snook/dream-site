	...
	<main class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6 mb-2">
				<div class="row">
					<div class="col p-4 bg-gray">
						...
						<p>Dream Dinners is easier than ever! Share your personal referral link to introduce your friends and family to Dream Dinners.</p>
						...
						<!--<div class="row pt-2">
							...
							<div class="col-md-8 col-xl-10">
								...
								<p class="p-1 text-muted font-italic font-size-small"></p>
							</div>
						</div>-->
			...
			<?php if (!empty($this->past_orders)) { ?>
				<div class="col-xl-6 mb-2 bg-gray">
					...
					<div class="row pb-2">
						<div class="col-6">
							<a class="btn btn-primary btn-block" href="/my-meals">Rate My Meals</a>
						</div>
						<div class="col-6">
							<a class="btn btn-gray-dark btn-block" href="/my-meals?tab=nav-past_orders">Order history</a>
						</div>
					</div>
				</div>
			<?php } ?>
			...
			<?php if (!$this->is_delivered_only) { ?>
				<div class="col-xl-6 mb-2 bg-gray-light">
					<?php if (!empty($this->usersFuturePastEvents['upcomingEvents'])) { ?>
						...
						<div class="row">
							<div class="col my-2">
								<a class="btn btn-primary btn-block" href="/my-events">My events</a>
							</div>
						</div>
					<?php } else { ?>
						<div class="row h-100">
					...
					<div class="row py-2">
						...
						<?php if (!empty($this->userCredits['credit']['available_pp_credits'])) { ?>
							<div class="col-md-6 mb-2">
								...
								<div class="font-italic font-size-small text-muted">PLATEPOINTS Dinner Dollars can only be used at participating stores.</div>
								<?php if (empty($this->store['supports_plate_points'])) { ?>
									<div class="font-italic font-size-small text-muted">Your independently-owned Home Store is not currently participating in the PLATEPOINTS program.</div>
								<?php } ?>
							</div>
						<?php } ?>
		...
		<div class="row">
			<div class="col">
				<div class="row">
					...
					<div class="col-sm-6 col-xl-3 mt-2">
						...
						<?php if (!empty($this->store['city'] )) { ?>
							...
							<div class="row mt-2">
								<div class="col">
									<a class="btn btn-primary btn-sm mb-2" href="/location/<?php echo $this->store['id']?>">Store details</a>
				...
				<div class="row mb-2">
					<div class="col">
						<a class="btn btn-primary btn-block" href="/account">Edit Settings</a>
					</div>
				</div>
			</div>
		</div>

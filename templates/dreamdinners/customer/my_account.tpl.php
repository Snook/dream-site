				...
				<div class="col-xl-6 mb-2 bg-gray-light">
					<div class="row pt-2">
						<div class="col-lg-12 py-2 py-xl-5 text-center">
							...
							<p>California and Colorado residents can request details about personal information collected and shared <a href="/main.php?page=account">by submitting a request</a>.</p>
						</div>
					</div>
				</div>
			<?php } ?>

			...
			<div class="container faq">
				<div class="row">
					<div class="col-md-8 mx-auto">
						...
						<p class="mb-3 text-center">Browse our list of help topics outlined below. If you still have questions and would like to speak with a team member at your local store, click <a href="/locations">Locations</a> to find the direct contact information for the store that you are interested in. Additionally, you can contact our home office from our <a href="/contact-us">Contact Us page</a> for website support or guest services.</p>

						<?php if (defined('ENABLE_HELP_SEARCH') && ENABLE_HELP_SEARCH == true) { ?>
							<a class="btn btn-primary btn-lg btn-block help-search-launcher" href="#">Launch Helpdesk</a>
						<?php } ?>
					</div>
				</div>
			</div>

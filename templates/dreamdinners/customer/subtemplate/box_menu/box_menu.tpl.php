...
<main class="container">
	...
	<div class="row mt-5">
		<p class="text-center"><i>Your local store may make substitutions to various ingredients based on availability. These substitutions can affect our nutritional information and may cause slight changes to what is listed for each recipe.</i></p>
	</div>
</main>
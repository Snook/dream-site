<div class="row mb-5">
	<div class="col-12 col-lg-6">
		...
		<p>At this event, you will assemble three delicious medium dinners to take home and enjoy with your family. You'll also learn about how easy homemade meals can be and help a deserving cause, all while having a fun time. We will donate $10 from each order to <?php echo $this->session['fundraiser_name']; ?>.</p>
		<p>Select three medium dinners for $<?php echo $this->session['dream_taste_price']; ?> from the menu below and complete the checkout process. We look forward to seeing you there.</p>

...
<div class="row mb-1">
	<div class="col-9 font-size-small">
		...
		<a class="card-link text-uppercase d-print-none link-dinner-details" href="/item?recipe=<?php echo $subItemData['recipe_id']; ?>" data-recipe_id="<?php echo $subItemData['recipe_id']; ?>" data-store_id="<?php echo $this->cart_info['storeObj']->id; ?>" data-menu_item_id="<?php echo $subItemData['id']; ?>" data-menu_id="<?php echo $mainItem->menu_id; ?>">

		...
		<div class="card-footer border-0 p-0">
			<div class="row bg-white mx-0 pt-2">
				<?php if (!$mainItem->is_bundle && !$mainItem->is_shiftsetgo) { ?>
					<div class="col-6">
						<a class="card-link text-uppercase d-print-none link-dinner-details" href="/main.php?page=item&amp;recipe=<?php echo $mainItem->recipe_id; ?>" data-recipe_id="<?php echo $mainItem->recipe_id; ?>" data-store_id="<?php echo $this->cart_info['storeObj']->id; ?>" data-menu_item_id="<?php echo $mainItem->id; ?>" data-menu_id="<?php echo $mainItem->menu_id; ?>">Dinner details</a>
					</div>
				<?php } ?>

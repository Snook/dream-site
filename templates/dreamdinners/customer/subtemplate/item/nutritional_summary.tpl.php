<div class="row">
	...
	<div class="col-12">
		<?php if (!empty($this->menu_item->allergens)) { ?>
			<p class="mb-0">Contains: <?php echo $this->menu_item->allergens; ?></p>
		<?php } ?>
		<p>May Contain: Milk, Eggs, Fish, Shellfish, Tree Nuts, Peanuts, Wheat, Soybeans, Sesame.</p>

		<?php if(!empty($this->menu_item->ingredients)){ ?>
			<p>Ingredients: <?php echo $this->menu_item->ingredients; ?></p>
		<?php } ?>

<main>
	<div class="container">
		...
		<?php if ($this->sessionInfo['session_type'] != CSession::DELIVERED) { ?>
			<div class="row mb-4">
				<?php if (!$this->sessionInfo['is_past']) { ?>
					<div class="col-12 col-lg-6 order-lg-2 d-print-none">
						<div class="row h-100 mb-3">
							...
							<div class="col-md-6">
								<a class="btn btn-primary btn-block" href="/main.php?page=my_events&amp;sid=<?php echo $this->sessionInfo['id']; ?>">
		...
		<div class="row mb-4">
			<?php if ($this->showPlatePointsEnroll) { ?>
				<div class="col-12 col-lg-6 text-center bg-cyan-extra-light">
					...
					<div class="form-row" id="plate-points-checkbox">
			...
			<?php } else { ?>
				<div class="col-12 col-lg-6 text-center bg-cyan-extra-light">
					...
					<a class="btn btn-secondary mt-3 mb-5" href="/main.php?page=my_meals">Start Rating My Meals</a>
				</div>
			<?php } ?>

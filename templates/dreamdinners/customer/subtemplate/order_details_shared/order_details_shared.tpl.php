...
<div class="row">
	...
	<div class="col-lg-3 mt-4 mt-lg-0 order-lg-1">
		...
		<div class="d-print-none">
			<?php if ($this->sessionInfo['session_type'] != CSession::DELIVERED) { ?>
				<a href="/main.php?page=print&amp;order=<?php echo $this->orderInfo['id']; ?>&amp;freezer=true" class="btn btn-lg btn-primary m-1 d-block" target="_blank">Freezer Sheet</a>
			<?php } ?>
			<a href="/main.php?page=print&amp;order=<?php echo $this->orderInfo['id']; ?>&amp;nutrition=true" class="btn btn-lg btn-primary m-1 d-block" target="_blank">Nutritionals</a>
			<?php if($this->store_allows_meal_customization) { ?>
				<a href="/main.php?page=account&amp;view=recipe_customization_row" class="btn btn-lg btn-cyan m-1 d-block" target="_blank">Meal Customizations</a>
			<?php } ?>
		</div>

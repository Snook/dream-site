<div class="row mb-4">
	...
	<div class="col-md-3">
		<a href="/main.php?page=item&amp;recipe=<?php echo $mainItem['recipe_id']; ?>">
	...
	<div class="col-md-9" id="description-<?php echo $mainItem['recipe_id']; ?>">
		...
		<h4><a href="/main.php?page=item&amp;recipe=<?php echo $mainItem['recipe_id']; ?>"><?php echo htmlspecialchars($mainItem['display_title']); ?></a></h4>

<div id="recipe_div-<?php echo $recipe['element_id']; ?>" class="col-12 col-lg-6" xmlns="http://www.w3.org/1999/html">
	<div class="row mb-3">
		...
		<div class="col-md-5 text-center mb-lg-4">
			...
			<?php if (!empty($recipe['cooking_instruction_youtube_id'])) { ?>
				<div class="d-inline-block">
					...
					<a href="/item?recipe=<?php echo $recipe['recipe_id']; ?>&amp;tab=video" class="font-size-small text-green text-uppercase text-decoration-underline">Preparation video</a>
				</div>
			<?php } ?>
		</div>
		...
		<div class="col-md-7 pl-md-0">
			<div class="row mb-2">
				<div class="col">
					<a class="font-size-medium-small text-uppercase font-weight-bold text-left my-meal-title mb-3" href="/item?recipe=<?php echo $recipe['recipe_id']; ?>"><?php echo htmlspecialchars($recipe['menu_item_name']); ?></a>
				</div>
			</div>

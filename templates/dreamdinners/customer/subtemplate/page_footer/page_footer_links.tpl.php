<?php if (empty($this->sticky_nav_bottom_disable)) { ?>
		...
		<section>
			<div class="container-fluid footer-nav border-bottom border-top border-green-dark py-2 mt-5 bg-white d-lg-none d-print-none">
				<div class="row">
					...
					<a href="/main.php?static=how_it_works" class="col-3 px-0 text-center font-size-small">
						<i class="dd-icon icon-measuring_cup font-size-medium-large text-green"></i>
						<div>How it Works</div>
					</a>
					<a href="/main.php?page=locations" class="col-3 px-0 text-center font-size-small">
	...
	<?php }else { ?>
		<section>
			<div class="container-fluid footer-nav border-bottom border-top border-green-dark py-2 mt-5 bg-white d-lg-none d-print-none">
				<div class="row">
					<a href="/main.php?page=browse_menu" class="col-4 pr-0 text-center font-size-small">
					...
					<a href="/main.php?page=locations" class="col-2 px-0 text-center font-size-small">
						<i class="dd-icon icon-cart font-size-medium-large text-green mr-1"></i>
						<div>Order</div>
					</a>
					<a href="#" data-toggle="collapse" data-target="#main-sidenav" aria-expanded="false" aria-label="Toggle main navigation" class="col-2 px-0 text-center font-size-small">
	...
	<div class="row">
		<div class="col-md-4 col-lg-3 col-xl-2">
			...
			<div class="list-group list-group-flush">
				...
				<?php } ?>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?page=gift_card_order">Gift Cards</a>
			</div>
		</div>
		<div class="col-md-4 col-lg-3 col-xl-2">
			<p class="font-weight-bold text-uppercase pl-1 mt-4 mt-md-0">Our Company</p>
			<div class="list-group list-group-flush">
				<a class="list-group-item bg-green-dark text-white py-0 border-top-0" href="/main.php?static=about_us">About Us</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?static=our_food">Our Food</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?static=job_opportunities">Careers</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?static=contact_us">Contact Us</a>
			</div>
		</div>
		<div class="col-md-4 col-lg-3 col-xl-2">
			<p class="font-weight-bold text-uppercase pl-1 mt-4 mt-md-0">Learn More</p>
			<div class="list-group list-group-flush">
				<a class="list-group-item bg-green-dark text-white py-0 border-top-0" href="/main.php?static=how_it_works">How It Works</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?page=platepoints">PlatePoints</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?static=promotions">Promotions</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?static=fundraisers">Fundraisers</a>
				<a class="list-group-item bg-green-dark text-white py-0" href="/main.php?page=recipe_resources">Recipe Resources</a>
		...
		<div class="row bg-green-dark">
			<div class="col">
				<ul class="list-inline font-size-small text-white text-center m-3">
					...
					<li class="list-inline-item"><a class="text-white d-print-none" href="/main.php?static=terms">Terms</a></li>
					<li class="list-inline-item"><a class="text-white d-print-none" href="/main.php?static=privacy">Privacy</a></li>
					<li class="list-inline-item"><a class="text-white d-print-none" href="/main.php?static=cookies">Cookies</a></li>
					<li class="list-inline-item"><a class="text-white d-print-none" href="/main.php?page=sitemap">Sitemap</a></li>
				</ul>
			</div>
		</div>
	</div>

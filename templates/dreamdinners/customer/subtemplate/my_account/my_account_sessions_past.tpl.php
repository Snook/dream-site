...
<div class="row my-1 mb-4">
	<div class="col-md-6 mb-1 text-center">
		<a class="btn btn-gray-dark btn-block" href="/order-details?order=<?php echo $order['id']; ?>"><?php echo CTemplate::dateTimeFormat($order['session_start'], $dateType); ?></a>
	</div>
	<?php if ($order['can_rate_my_meals']) { ?>
	<div class="col-6 col-md-3 pr-1">
		<a class="btn btn-primary btn-block" href="/my-meals?order=<?php echo $order['id']; ?>">
	...
	<div class="col-6 col-md-3 pl-1">
		<a class="btn btn-primary btn-block" href="/print?order=<?php echo $order['id']; ?>&amp;freezer=true" target="_blank">

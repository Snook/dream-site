		...
		<div class="row mb-5">
			<div class="col-md-6 p-5 text-center mx-auto bg-gray">
				...
				<?php if (!empty($this->DAO_store->AvailableJobsArray)) { ?>
					...
					<p>We are always accepting applications. Our store is currently hiring for the following positions</p>
					<div class="row">
				...
				<?php } else { ?>
					<p>Join our Dream Dinners team. We are always accepting applications. Submit your resume to <a href="mailto:<?php echo $this->DAO_store->email_address; ?>"><?php echo $this->DAO_store->email_address; ?></a>.</p>
				<?php } ?>
			</div>

...
<div class="row">
	<div class="col text-center">
		<ul class="nav justify-content-around justify-content-md-between">
			...
			<?php if ($this->DAO_store->hasBioPage()) { ?>
				<li class="nav-item mb-3">
					<i class="dd-icon icon-friend font-size-extra-extra-large text-cyan-dark m-4"><a class="m-auto nav-link text-uppercase font-weight-bold" style="width: 10rem; height: 10rem;" href="<?php echo $this->DAO_store->getPrettyUrl(); ?>/meet-the-owner">Meet the owner</a></i>

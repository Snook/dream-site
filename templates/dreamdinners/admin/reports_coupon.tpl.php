        ...
        <div id="report_area">
            ...
            <table class='report' width='100%' border='0' cellpadding='0' cellspacing='0' >
                <tr>
                    ...
                    <td align="right">
                        <?php
                        $exportAllLink = '/backoffice/reports-coupon?store=' . $this->store . '&day=' . $this->report_day . '&month=' . $this->report_month .
                ...
                <table class='report' width='100%' border='0' cellpadding='4' cellspacing='0' >
                    ...
                    <?php foreach($this->report_data as $aRow) {	?>
                        <tr>
                            ...
                            <?php if ($this->all_stores) { ?>
                                <td  class="cc_data_cell" ><a href="/backoffice/reports-coupon?coupon_detail=true&coupon=<?=$aRow['id']?>&day=<?=$this->report_day?>&month=<?=$this->report_month?>

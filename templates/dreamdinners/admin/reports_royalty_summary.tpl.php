...
<?php if (!$this->print_view) { ?>
	<a href="main.php?page=admin_reports_royalty&amp;store=<?php echo $array_entity['store_id']; ?>&amp;month_popup=<?php echo $this->report_month; ?>&amp;year_field_001=<?php echo $this->report_year; ?>&amp;report_submit=true&amp;print=true"><img src="<?php echo ADMIN_IMAGES_PATH; ?>/icon/printer.png" class="img_valign"></a>
<?php
	$exportAllLink = 'main.php?page=admin_reports_royalty&store=' . $array_entity['store_id'] . '&day=' . $this->report_day . '&month=' . $this->report_month . '&year=' . $this->report_year . '&duration=' . urlencode($this->report_duration) . '&report_type=' . $this->report_type .  '&export=xlsx';
...
<table class="report">
<tr>
	<td class="headers" style="width:40%;font-weight:bold;">Royalty Summary</td>
	<td class="headers" style="width:60%;font-weight:bold;">Totals</td>
</tr>
<tr>
...
<tr>
	<td style="font-weight:bold;">Gross Income (Less Taxes):</td>
	<td><?php echo CSessionReports::formatCurrency($array_entity['grand_total_less_taxes']); ?></td>
</tr>

<tr>
	<td style="font-weight:bold;">Discounts:</td>
	<td>(<?php echo CSessionReports::formatCurrency($array_entity['discounts']); ?>)</td>
</tr>
<tr>
	<td style="font-weight:bold;">Adjustments (+/-):</td>
	<td><?php echo ($array_entity['adjustments'] < 0) ? '(' . CSessionReports::formatCurrency($array_entity['adjustments']) . ')' : CSessionReports::formatCurrency($array_entity['adjustments']); ?></td>
</tr>
<tr>
	<td style="font-weight:bold;">Fundraising Contributions:</td>
	<td>(<?php echo CSessionReports::formatCurrency($array_entity['fundraising_total']); ?>)</td>
</tr>
    <?php if (isset($array_entity['ltd_menu_item_value'])) { ?>
        <tr>
            <td style="font-weight:bold;">Menu Item Donations Owed to Dream Dinners Foundation:</td>
            <td>(<?php echo CSessionReports::formatCurrency($array_entity['ltd_menu_item_value']); ?>)</td>
        </tr>
    <?php } ?>


    <?php if (false && isset($array_entity['subtotal_delivery_fee'])) { ?>
        <tr>
            <td style="font-weight:bold;">Total Delivery Fees Owed to Delivery Vendor:</td>
            <td>(<?php echo CSessionReports::formatCurrency($array_entity['subtotal_delivery_fee']); ?>)</td>
        </tr>
    <?php } ?>
...
<tr>
    ...
    <?php if (isset($array_entity['ltd_round_up_value'])) { ?>
<tr>
	<td style="font-weight:bold;">Round Up Donations Owed to Dream Dinners Foundation:</td>
	<td><?php echo CSessionReports::formatCurrency($array_entity['ltd_round_up_value']); ?></td>
</tr>
<?php } ?>
<?php if (isset($array_entity['ltd_menu_item_value'])) { ?>
<tr>

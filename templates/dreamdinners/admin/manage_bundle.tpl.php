	...
	<div class="container-fluid">
		...
		<div class="row my-4">
			<div class="col text-center">
				<h1><a href="main.php?page=admin_manage_bundle">Manage Bundles</a></h1>
			</div>
		</div>
		...
		<?php } else { ?>
			...
			<table class="table table-hover table-hover-cyan table-striped-2 bg-white ddtemp-table-border-collapse">
				...
				<tr class="text-center">
					...
					<th>Servings Req</th>
					<th>Price</th>
					<th><a href="main.php?page=admin_manage_bundle&amp;create" class="button">Create Bundle</a></th>
				</tr>
				</thead>
				<tbody>
				<?php foreach($this->bundleArray AS $bundle) { ?>
					<tr>
						...
						<td class="text-right">
							...
							<a href="main.php?page=admin_manage_bundle&amp;edit=<?php echo $bundle->id; ?>" data-bundle_id="<?php echo $bundle->id; ?>" class="edit_bundle button">Edit</a>
						</td>
					</tr>

		...
		<table class="table table-sm table-striped" style="width:100%;">
			...
			while( $this->rows->fetch() )
			{
				...
				<tr class="bgcolor_<?php echo ($counter++ % 2 == 0) ? 'light' : 'lighter'; ?>">
					...
					<td style="white-space:nowrap;text-align:center;"><a href="/?page=admin_user_details&amp;id=<?php echo $this->rows->id; ?>&amp;back=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" class="button" >View Acct</a></td>
					...
					<td style="white-space:nowrap;text-align:center;"><a href="/?page=admin_order_history&amp;id=<?php echo $this->rows->id; ?>&amp;back=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" class="button">Orders</td>

...
<tr>
	...
	<td class="bgcolor_medium header_row"><a href="/backoffice/manage_dream_event_theme?create" class="btn btn-primary btn-sm">Create Theme</a></td>
</tr>
...
<tr>
	...
	<td class="bgcolor_light" style="text-align: center;"><a href="/backoffice/manage_dream_event_theme?edit=<?php echo $bundleTheme->id; ?>" class="btn btn-primary btn-sm">Edit</a></td>
</tr>
<?php } ?>
</table>

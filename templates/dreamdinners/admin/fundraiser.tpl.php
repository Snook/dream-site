	...
	<div class="container-fluid">
		...
		<div class="row my-4">
			<div class="col-4 offset-4 text-center ">
				<h1><a href="/backoffice/fundraiser">Fundraising Manager</a></h1>
			</div>
					...
					<?php if (!empty($this->fundraiserArray)) { ?>
						<?php foreach ($this->fundraiserArray AS $id => $fundraiser) { ?>
							<tr data-fund_id="<?php echo $id; ?>">
								...
								<td data-fund_title="<?php echo $fundraiser->fundraiser_name; ?>"><a href="/fundraiser?id=<?php echo $this->store->id; ?>&amp;fid=<?php echo $fundraiser->id; ?>" target="_blank"><?php echo $fundraiser->fundraiser_name; ?></a></td>

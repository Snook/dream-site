...
<div class="container">
    <iframe class="dd_content" data-has_loaded="false" id="calendar" data-content_id="calendar" data-content_source="<?= HTTPS_SERVER?>/main.php?page=admin_session_mgr" src=""></iframe>
    <iframe class="dd_content" data-has_loaded="false" id="fadmin" data-content_id="fadmin" data-content_source="<?= HTTPS_SERVER?>/main.php?page=admin_main" src=""></iframe>

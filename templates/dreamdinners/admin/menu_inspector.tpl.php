				...
				<?php if (is_array($subArray)) { ?>
					...
					<?php foreach ($subArray as $id => $planNode) { ?>
						<tr>
							...
							<td>
								<div class="mb-2 font-weight-bold"><a href="/item?recipe=<?php echo $planNode['recipe_id']; ?>&amp;ov_menu=<?php echo $this->menuInfo['menu_id']; ?>" target="_blank"><?php echo $planNode['title']; ?></a></div>

...
<tr>
	<td class="bgcolor_lighter" id="recipe_row-<?php echo $id; ?>"><div id="recipe_row_disc-<?php echo $id; ?>" class="disc_closed"></div><a href="main.php?page=admin_food_testing_survey&amp;recipe=<?php echo $id; ?>"><?php echo $recipe['title']; ?></a></td>
...
<tr>
	<td colspan="8">
		...
		<tr id="survey_row-<?php echo $survey['id']; ?>">
			<td class="bgcolor_light"><a href="main.php?page=admin_user_details&amp;id=<?php echo $survey['user_id']; ?>"><?php echo ucfirst($survey['firstname']); ?> <?php echo ucfirst($survey['lastname']); ?></a></td>

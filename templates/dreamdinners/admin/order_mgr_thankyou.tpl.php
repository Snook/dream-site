...
<?php if ($this->bookingStatus == CBooking::CANCELLED) { ?>
	<h1>Canceled Order details for <a href="/backoffice/user-details?id=<?php echo $this->orderInfo['user_id']; ?>"><?php echo $this->customerName; ?></a></h1>
<?php } else { ?>
	<h1>Order details for <a href="/backoffice/user-details?id=<?=$this->orderInfo['user_id']?>"><?php echo $this->customerName; ?></a></h1>
<?php } ?>
	<table style="width: 100%; margin-bottom: 10px;">
		<tr>
			<td>
				<a href="/backoffice" class="btn btn-primary btn-sm">Admin Home</a>
				...
				<a href="/backoffice/user-details?id=<?php echo $this->orderInfo['user_id']; ?>" class="btn btn-primary btn-sm">Guest Details</a>

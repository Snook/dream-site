	...
	<form action="" method="post" onSubmit="return override_check_form(this);" >
		...
		<table style="width: 100%; margin-bottom: 10px;">
			...
			<tr>
				...
				<td class="bgcolor_light">
					<?php if ($isSiteAdmin) { ?><a href="main.php?page=admin_franchise_details&amp;id=<?php echo $this->form_store_details['franchise_id']; ?>&amp;back=<?php echo urlencode($_SERVER['REQUEST_URI']); ?>" class="button" style="float: right;">View Entity</a><?php } ?>

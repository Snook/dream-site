		...
		<div class="row mb-4">
			<div class="col">
				<div class="list-group list-group-horizontal mb-2">
					<a class="list-group-item list-group-item-action" href="main.php?page=print&amp;menu=<?php echo $this->current_menu_id; ?>&amp;store=<?php echo $this->store_id; ?>" target="Print_Menu">Print Menu <?php echo $this->current_menu_name; ?></a>
					<a class="list-group-item list-group-item-action" href="main.php?page=print&amp;menu=<?php echo $this->next_menu_id; ?>&amp;store=<?php echo $this->store_id; ?>"  target="Print_Menu">Print Menu <?php echo $this->next_menu_name; ?></a>
				</div>
				<div class="list-group">
					...
					<a class="list-group-item list-group-item-action" href="main.php?page=admin_link_utility">Link Creation Utility</a>
					...
					<?php if ($this->user_type != CUser::FRANCHISE_STAFF) { ?>
						<a class="list-group-item list-group-item-action" href="main.php?page=admin_signature_generator">Signature Generator</a>
					<?php } ?>

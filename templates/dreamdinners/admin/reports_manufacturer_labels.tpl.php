...
<tr>
	<td class="bgcolor_light" style="text-align:right;"><a href="main.php?page=item&amp;recipe=<?php echo $recipe['info']['recipe_id']; ?>" target="_blank"><?php echo $recipe['info']['recipe_id']; ?></a></td>

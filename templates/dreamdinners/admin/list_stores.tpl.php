...
<tr>
	<td>
		<a href="/backoffice/list_stores?letter_select=A" class="button">A</a>
		<a href="/backoffice/list_stores?letter_select=B" class="button">B</a>
		<a href="/backoffice/list_stores?letter_select=C" class="button">C</a>
		<a href="/backoffice/list_stores?letter_select=D" class="button">D</a>
		<a href="/backoffice/list_stores?letter_select=E" class="button">E</a>
		<a href="/backoffice/list_stores?letter_select=F" class="button">F</a>
		<a href="/backoffice/list_stores?letter_select=G" class="button">G</a>
		<a href="/backoffice/list_stores?letter_select=H" class="button">H</a>
		<a href="/backoffice/list_stores?letter_select=I" class="button">I</a>
		<a href="/backoffice/list_stores?letter_select=J" class="button">J</a>
		<a href="/backoffice/list_stores?letter_select=K" class="button">K</a>
		<a href="/backoffice/list_stores?letter_select=L" class="button">L</a>
		<a href="/backoffice/list_stores?letter_select=M" class="button">M</a>
		<a href="/backoffice/list_stores?letter_select=N" class="button">N</a>
		<a href="/backoffice/list_stores?letter_select=O" class="button">O</a>
		<a href="/backoffice/list_stores?letter_select=P" class="button">P</a>
		<a href="/backoffice/list_stores?letter_select=Q" class="button">Q</a>
		<a href="/backoffice/list_stores?letter_select=R" class="button">R</a>
		<a href="/backoffice/list_stores?letter_select=S" class="button">S</a>
		<a href="/backoffice/list_stores?letter_select=T" class="button">T</a>
		<a href="/backoffice/list_stores?letter_select=U" class="button">U</a>
		<a href="/backoffice/list_stores?letter_select=V" class="button">V</a>
		<a href="/backoffice/list_stores?letter_select=W" class="button">W</a>
		<a href="/backoffice/list_stores?letter_select=X" class="button">X</a>
		<a href="/backoffice/list_stores?letter_select=Y" class="button">Y</a>
		<a href="/backoffice/list_stores?letter_select=Z" class="button">Z</a>
		<a href="/backoffice/list_stores?letter_select=etc" class="button">ETC</a>
		<a href="/backoffice/list_stores?letter_select=all" class="button">Show	All</a>
	</td>
</tr>
</table>

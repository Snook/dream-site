															...
															<table style="width:100%;">
																<tr>
																	<td style="text-align:center">
																		<b><?= $this->monthtitle ?> <?= $this->currentYear ?></b>
																	</td>
																</tr>
															</table>
														</td>
		...
		<div>
			...
			<div>
				<table style="width:100%; border:thin gray solid;">
					...
					<?php } ?>
					<tr>
						<td style="text-align:right;" colspan="3"><span id="cost_inputter_status_msg" style="display:none; color:red;"></span> <button id="cost_inputter_close">Close</button>&nbsp;&nbsp;<button id="cost_inputter_save">Save</button>&nbsp;&nbsp;</td>
					</tr>
				</table>
			</div>
		</div>

							...
							foreach($thisWeek as $date => $thisDay)
							{
								...
								foreach($thisDay as $sessionTime => &$thisSession)
								{
									...
									<tr id="wid_<?php echo $weekNumber ?>-did_<?php echo $date?>-sid_<?php echo $thisSession['session_id']?>" data-interweek_day_count="<?php echo $interWeekDayCount;?>">
										...
										<td class="<?php echo $add_class;?> session_cell" id="ses_<?php ?><?php echo $thisSession['session_id'];?>"><a href="main.php?page=admin_main&session=<?php echo $thisSession['session_id'];?>&back=main.php?page=admin_reports_goal_management_v2"><?php echo $sessionTime;?></a></td>

	...
	<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2" class="form_field_cell" style="border:2px #808080 solid;">
		...
		<?php if ($this->PlatePointsRulesVersion > 1) { ?>
			<tr>
				...
				<td width="5"></td>
				<td></td>
				<td style="display:none" align="right"><?php echo $this->requiredMinimumType == COrderMinimum::SERVING ? $this->orderInfo['servings_core_total_count'] : $this->orderInfo['menu_items_core_total_count']; ?>/<?php echo $this->requiredMinimum ?></td>
			</tr>
		<?php } ?>
		<tr>
		...
		<tr id="miscFoodRow">
			...
			<td style="display:none" align="right"><span id="OEH_misc_food_subtotal_org"><?=$miscFoodSubtotal?></span></td>
		</tr>

		<?php $foodTotal = $this->moneyFormat($this->orderInfo['misc_food_subtotal'] + $this->orderInfo['subtotal_menu_items']+ $this->orderInfo['subtotal_home_store_markup'] - ($this->isEmptyFloat($this->orderInfo['bundle_discount']) ? 0 : $this->orderInfo['bundle_discount'])); ?>
		...
		<tr>
			...
			<td style="display:none" align="right"><?=$foodTotal?></td>
		</tr>
		...
		<tr id="productSubtotalRow">
			...
			<td width="5"></td>
			<td align="right">$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_products_subtotal_org"><?=$this->moneyFormat($this->orderInfo['subtotal_products'] - $this->orderInfo['misc_nonfood_subtotal'])?></span></td>
		</tr>
		...
		<tr id="miscNonFoodRow">
			...
			<td width="5"></td>
			<td align="right" style="display:none">$&nbsp;</td>
			<td align="right" style="display:none"><span id="OEH_misc_nonfood_subtotal_org"><?=$miscNonFoodSubtotal?></span></td>
		</tr>
		...
		<tr id="preferredUserDiscountRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">-$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_preferred_org"><?= $this->moneyFormat($this->orderInfo['user_preferred_discount_total']) ?></span></td>
		</tr>
		...
		<tr id="platePointsDiscountRow">
			...
			<td width="5"></td>
			<td align="right" style="display:none">-$&nbsp;</td><td align="right" style="display:none"><span id="OEH_plate_points_discount_org_food"><?= $this->moneyFormat($this->orderInfo['points_discount_total_food']) ?></span></td>
		</tr>
		...
		<tr id="sessionDiscountRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">-$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_session_discount_org"><?= $this->moneyFormat($this->orderInfo['session_discount_total']) ?></span></td>
		</tr>
		...
		<tr id="ServiceFeeRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_subtotal_service_fee_org"><?= $this->moneyFormat($this->orderInfo['subtotal_service_fee']) ?></span></td>
		</tr>
		...
		<tr id="BagFeeRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_subtotal_bag_fee_org"><?= $this->moneyFormat($this->orderInfo['subtotal_bag_fee']) ?></span></td>
		</tr>
		...
		<tr id="DeliveryTipRow" class="collapse">
			<td>Driver Tip</td>
			<td align="right" style="color:blue;">$&nbsp;</td>
			<td align="right"><span id="OEH_delivery_tip" style="color:blue;"><?= $this->moneyFormat($this->orderInfo['delivery_tip']) ?></span></td>
			<td width="5"></td>
			<td class="text-right collapse">$&nbsp;</td>
			<td class="text-right collapse"><span id="OEH_delivery_tip_org"><?= $this->moneyFormat($this->orderInfo['delivery_tip']) ?></span></td>
		</tr>
		...
		<tr id="MealCustomizationFeeRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right" align="right">$&nbsp;</td>
			<td style="display:none" align="right" align="right"><span id="OEH_subtotal_meal_customization_fee_org"><?= $this->moneyFormat($this->orderInfo['subtotal_meal_customization_fee']) ?></span></td>
		</tr>
		...
		<tr id="ServiceTaxRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_service_tax_subtotal_org"><?= $this->moneyFormat($this->orderInfo['subtotal_service_tax']) ?></span></td>
		</tr>
		...
		<tr id="BagFeeTaxRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_bag_fee_tax_subtotal_org"><?= $this->moneyFormat($this->orderInfo['subtotal_bag_fee_tax']) ?></span></td>
		</tr>
		...
		<tr id="LTDRoundUpRow">
			...
			<td width="5"></td>
			<td style="display:none" align="right">$&nbsp;</td>
			<td style="display:none" align="right"><span id="OEH_ltd_round_up_org"><?= $this->moneyFormat($this->orderInfo['ltd_round_up_value']) ?></span></td>
		</tr>
										...
										<div>
											<div style="float:right">
													<span id="gd_delete_order-<?php echo $this->orderInfo['id']; ?>" data-user_id="<?php echo $this->orderInfo['user_id']; ?>" data-store_id="<?php echo $this->orderInfo['store_id']; ?>"
														  data-session_id="<?php echo $this->sessionInfo['id'] ?>" data-order_id="<?php echo $this->orderInfo['id']; ?>" data-bounce="/backoffice/order-mgr?user=<?php echo $this->orderInfo['user_id']; ?>" class="btn btn-primary btn-sm">Delete Saved Order</span>
											</div>
										</div>
									</td>
								<?php } else { ?>

	...
	<div class="container-fluid">
		...
		<div class="row my-4">
			<div class="col-lg-6 text-center mb-3 order-lg-2">
				<h1><a href="/backoffice/manage_box">Manage Boxes</a></h1>
			</div>
			...
			<div class="col-4 col-lg-3 text-center text-lg-right order-lg-3">
				<a  href="/backoffice/manage_box?create=true" class="btn btn-primary btn-sm"><i class="far fa-plus-square"></i> Create New</a>
			</div>
		</div>
					...
					<div class="col-md-6 py-2">
						<div class="row">
							...
							<div class="col-6 mb-2">
								<a href="/backoffice/manage_box?edit=<?php echo $box->id; ?>" class="btn btn-primary btn-block">Edit box</a>
							</div>
							<div class="col-6 mb-2">

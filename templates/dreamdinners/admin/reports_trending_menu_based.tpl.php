...
<div style="float:right"><a href="/?page=admin_reports_trending" class="button">Calendar-Month Trending Report</a></div>

</div>
<div style="text-align:center; margin-bottom:10px;"><h2></h2></div>

<form id="reports_trending_form" action="?page=admin_reports_trending_menu_based" method="post">

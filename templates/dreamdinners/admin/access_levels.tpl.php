...
<?php } else { ?>
	<input type="button" class="button" value="Back" onclick="window.location = 'main.php?page=admin_user_details&id=<?php echo  $this->id?>';">
<?php } ?>
...
<tr>
	<td class="bgcolor_light"><?php if ($this->isAdmin || (!empty($this->currentStoreID) && $this->currentStoreID  == $store_id)) { ?><a href="main.php?page=admin_store_details&amp;id=<?php echo $thisStore['id']; ?>"><?php echo $thisStore['name']; ?></a><?php } else { ?><?php echo $thisStore['name']; ?><?php } ?></td>
...
<table style="width:100%">
	...
	<?php foreach ($this->users_franchises as $id => $thisFranchise) { ?>
		<tr>
			<td class="bgcolor_light"><?php if ($this->isAdmin) { ?><a href="main.php?page=admin_franchise_details&amp;id=<?php echo $thisFranchise['id']; ?>"><?php echo $thisFranchise['id']; ?></a><?php } else { ?><?php echo $thisFranchise['id']; ?><?php } ?></td>
			<td class="bgcolor_light"><?php if ($this->isAdmin) { ?><a href="main.php?page=admin_franchise_details&amp;id=<?php echo $thisFranchise['id']; ?>"><?php echo $thisFranchise['franchise_name']; ?></a><?php } else { ?><?php echo $thisFranchise['franchise_name']; ?><?php } ?></td>

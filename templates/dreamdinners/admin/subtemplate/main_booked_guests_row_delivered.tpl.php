				...
				<td rowspan="<?php echo $rowspan;?>" class="value guest">
					...
					<div id="gd_guest_menu-<?php echo $booking['id']; ?>" class="guest_menu_div">
						<ul class="guest_menu">
							...
							<?php } else { ?>
								<li><a href="?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">GONE</a></li>
							...
							<li><a href="?page=admin_order_mgr_delivered&amp;user=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Place <?php echo $this->date['this_M']; ?> Order</a></li>

<table id="session_details_table">
	...
	<?php if (!empty($this->session_info['session_host'])) { ?>
		<tr>
			...
			<td colspan="3" class="value"><a href="main.php?page=admin_user_details&amp;id=<?php echo $this->session_info['session_host']; ?>"><?php echo $this->session_info['session_host_firstname']; ?> <?php echo $this->session_info['session_host_lastname']; ?></a></td>
		</tr>
	<?php } ?>
	...
	<?php if ($this->session_info['session_type'] == CSession::FUNDRAISER && !empty($this->session_info['dream_taste_available_on_customer_site'])) { ?>
		<tr>
			...
			<td colspan="3" class="value">
				<a href="main.php?page=fundraiser&amp;id=<?php echo $this->session_info['store_id']; ?>&amp;fid=<?php echo $this->session_info['fundraiser_id']; ?>" target="_blank"><?php echo $this->session_info['fundraiser_name']; ?></a>
			</td>
		</tr>
		<tr>
			<td class="label">Fundraiser page</td>
			<td colspan="3" class="value">
				<input type="text" value="<?php echo HTTP_BASE; ?>main.php?page=fundraiser&amp;id=<?php echo $this->session_info['store_id']; ?>&amp;fid=<?php echo $this->session_info['fundraiser_id']; ?>" class="form-control form-control-sm" />
			</td>
		</tr>
		<tr>
			<td class="label">Operations</td>
	...
	<?php if (!empty($this->session_info['session_lead'])) { ?>
		<tr>
			...
			<td colspan="3" class="value"><a href="main.php?page=admin_user_details&amp;id=<?php echo $this->session_info['session_lead']; ?>"><?php echo $this->session_info['lead_firstname']; ?> <?php echo $this->session_info['lead_lastname']; ?></a></td>
		</tr>
	<?php } ?>
	...
	<?php if ($this->session_info['session_type_true'] == CSession::REMOTE_PICKUP || $this->session_info['session_type_true'] == CSession::REMOTE_PICKUP_PRIVATE) { ?>
		...
		<?php if (!empty($this->session_info['session_remote_location']->contact_user_id)) { ?>
			<tr>
				...
				<td colspan="3" class="value">
					<a href="main.php?page=admin_user_details&amp;id=<?php echo $this->session_info['session_remote_location']->contact_user->id; ?>"><?php echo $this->session_info['session_remote_location']->contact_user->firstname; ?> <?php echo $this->session_info['session_remote_location']->contact_user->lastname; ?></a>
				</td>
			</tr>
		<?php } ?>
	<?php } ?>
	...
	<?php if (!empty($this->session_info['created_by'])) { ?>
		<tr>
			...
			<td colspan="3" class="value"><a href="main.php?page=admin_user_details&amp;id=<?php echo $this->session_info['created_by']; ?>"><?php echo $this->session_info['created_by_firstname']; ?> <?php echo $this->session_info['created_by_lastname']; ?></a></td>
		</tr>
		<tr>
	...
	<?php if (!empty($this->session_info['updated_by'])) { ?>
		<tr>
			...
			<td colspan="3" class="value"><a href="main.php?page=admin_user_details&amp;id=<?php echo $this->session_info['updated_by']; ?>"><?php echo $this->session_info['updated_by_firstname']; ?> <?php echo $this->session_info['updated_by_lastname']; ?></a></td>
		</tr>
		<tr>

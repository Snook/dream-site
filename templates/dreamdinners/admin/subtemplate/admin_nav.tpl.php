		...
		<tr>
			...
			<td style="vertical-align:top;">
				...
				<?php if (isset($this->helpLinkSection)) { ?>
					<a href="javascript:NewWindowScroll('/backoffice/help-system?section=<?php echo $this->helpLinkSection; ?>','Help','675','575');" class="fadmin_nav fadmin_nav_right"><img src="<?php echo ADMIN_IMAGES_PATH; ?>/icon/help.png" alt="Print" style="vertical-align:middle;" /> Page Help</a>
				<?php } ?>
			</td>
		</tr>
	</table>

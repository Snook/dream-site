				...
				<td class="value small_value">
					<?php if ($booking['dream_reward_status'] == 1 || $booking['dream_reward_status'] == 3) {
						...
						<?php } else { ?>
							...
							<div>Points: <span data-pp_user_lifetime_points="<?php echo $booking['user_id']; ?>"><a href="/?page=admin_user_plate_points&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>"><?php echo number_format($booking['user']->platePointsData['lifetime_points']); ?></a></span></div>
						<?php } } else { ?>
						No
					<?php } ?>
				</td>

...
<table width="100%" border="0">
	...
	<tr>
		...
		<td colspan="3" class="bgcolor_light">
			$<?php echo CTemplate::number_format($this->storeInfo['grand_total_less_taxes']); ?>
		</td>
	</tr>
	<tr>
		<td class="bgcolor_light" style="vertical-align: top; text-align: right; padding-right:5px;">
	...
	<tr>
		...
		<td colspan="3" class="bgcolor_light">
			(<?php echo CSessionReports::formatCurrency($this->storeInfo['grand_total_less_taxes'] - $this->storeInfo['total_less_discounts']); ?>)
		</td>
	</tr>
	<tr>
		<td class="bgcolor_light" style="vertical-align: top; text-align: right; padding-right:5px;">
		...
		<td colspan="3" class="bgcolor_light">
			$<span id="p_and_l_total_agr"><?php echo CTemplate::number_format($this->storeInfo['total_less_discounts']); ?></span>
		</td>
	</tr>
	<tr>

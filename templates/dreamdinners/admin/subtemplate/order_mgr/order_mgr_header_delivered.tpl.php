<td width="50%" rowspan="2" valign="top" >
	...
	<table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2"  class="form_field_cell" style="border:2px #808080 solid;">
		...
		<tr>
			...
			<td width="5"></td>
			<td></td>
			<td align="right"><?php echo count($this->current_boxes);  ?></td>
		</tr>
		<tr>
		...
		<tr >
			...
			<td align="right">
				<span id="OEH_menu_subtotal" style="color:blue;">
					<?= $this->moneyFormat($this->orderInfo['subtotal_menu_items'] + $this->orderInfo['subtotal_home_store_markup'] - $this->orderInfo['bundle_discount']); ?>
				</span>
			</td>
			<td width="5"></td>
		...
		<tr id="dinnerDollarsDiscountRow">
			...
			<td  align="right" style="color:blue;">-$&nbsp;</td>
			<td align="right"><span id="OEH_plate_points_order_discount_fee" style="color:blue;"><?= $this->moneyFormat($this->orderInfo['points_discount_total']) ?></span></td>
			<td width="5"></td>
			<td  align="right">-$&nbsp;</td><td align="right"><span id="OEH_plate_points_discount_org_fee"><?= $this->moneyFormat($this->orderInfo['points_discount_total']) ?></span></td>
		</tr>
		...
		<tr id="DeliveryTipRow" class="collapse">
			...
			<td width="5"></td>
			<td  align="right">$&nbsp;</td>
			<td align="right"><span id="OEH_delivery_tip_org"><?= $this->moneyFormat($this->orderInfo['delivery_tip']) ?></span></td>
		</tr>
		...
		<tr>
			...
			<td width="5"></td>
			<td align="right">$&nbsp;</td>
			<td align="right"><?= $this->moneyFormat($this->orderInfo['grand_total']) ?></td>
		</tr>
				...
				<td>
					...
					<table width="100%">
						...
						<tr>
							...
							<td align="right"><b><span id="OEH_org_total"><?= $this->moneyFormat(floatval($this->orderInfo['grand_total']) + floatval($this->orderInfo['ltd_round_up_value'])) ?></span></b></td>
						</tr>
					</table>
						...
						<tr>
							...
							<td style="text-align: right;">
								<?php if (!$this->discountEligable['limited_access'] && $this->orderState != 'CANCELLED'){ ?>
									<span id="gd_cancel_delivered_order-<?php echo $this->orderInfo['id']; ?>" data-user_id="<?php echo $this->orderInfo['user_id']; ?>" data-store_id="<?php echo $this->orderInfo['store_id']; ?>" data-session_id="<?php echo $this->sessionInfo['id']; ?>" data-order_id="<?php echo $this->orderInfo['id']; ?>" data-bounce="/backoffice/main_delivered" class="btn btn-primary btn-sm">Cancel Order</span>
								<?php } ?>
								<input class="btn btn-primary btn-sm" type="button" value="Reset to Current" onClick="resetPage();"></td>
						</tr>
					</table>
				</td>
			</tr>

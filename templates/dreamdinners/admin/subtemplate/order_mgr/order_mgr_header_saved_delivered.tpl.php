					...
					<td>
						<table width="100%">
							<tr>
								...
								<td align="right" width="50"><b><span id="OEH_org_total"><?= $this->moneyFormat(floatval($this->orderInfo['grand_total']) + floatval($this->orderInfo['ltd_round_up_value'])) ?></span></b></td>
							</tr>
						</table>
										...
										<div>
											<div style="float:right">
													<span id="gd_delete_delivered_order-<?php echo $this->orderInfo['id']; ?>" data-user_id="<?php echo $this->orderInfo['user_id']; ?>" data-store_id="<?php echo $this->orderInfo['store_id']; ?>"
														  data-session_id="<?php echo $this->sessionInfo['id'] ?>" data-order_id="<?php echo $this->orderInfo['id']; ?>" data-bounce="/backoffice/order-mgr-delivered?user=<?php echo $this->orderInfo['user_id']; ?>" class="btn btn-primary btn-sm">Delete Saved Order</span>
											</div>
										</div>
									</td>
								<?php } else { ?>

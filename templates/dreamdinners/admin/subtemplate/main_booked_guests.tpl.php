		...
		foreach ($this->session_info['bookings'] AS $booking)
		{
			...
			<tr>
				<td rowspan="<?php echo $rowspan;?>" class="value guest">
					...
					<div style="float: right;">
						...
						<?php if ($booking['user']->platePointsData['status'] == 'active' || $booking['user']->platePointsData['userIsOnHold']) { ?>
							...
							<?php } ?>
						<?php } ?>
						<?php if (!empty($booking['preferred_type'])) { ?><a href="main.php?page=admin_preferred&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>"><img alt="Preferred Guest" src="<?php echo ADMIN_IMAGES_PATH; ?>/icon/star_grey.png" class="float-right ml-1" data-tooltip="Preferred Guest" /></a><?php } ?>
					...
					<div id="gd_guest_menu-<?php echo $booking['id']; ?>" class="guest_menu_div">
						<ul class="guest_menu">
							...
							<li><a href="main.php?page=admin_user_details&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">View Guest</a></li>
							<li><a href="main.php?page=admin_account&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Edit Guest</a></li>
							<li><a href="main.php?page=admin_email&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Email Guest</a></li>
							...
							<?php if ($booking['status'] != CBooking::RESCHEDULED) { ?>
								<li><a data-view_order_details="<?php echo $booking['id']; ?>" data-booking_id="<?php echo $booking['id']; ?>" data-order_id="<?php echo $booking['order_id']; ?>"
									   href="main.php?page=admin_order_history&amp;id=<?php echo $booking['user_id']; ?>&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">View Order</a></li>
							<?php } ?>
							<?php if (!empty($booking['can_edit'])) { ?>
								<li><a href="main.php?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Edit Order</a></li>
							<?php } else { ?>
								<li><a href="main.php?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Edit Payments</a></li>
							...
							<?php } ?>
							<li><a href="main.php?page=admin_order_mgr&amp;user=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Place <?php echo $this->date['this_M']; ?> Order</a></li>
							<li><a href="main.php?page=admin_order_mgr&amp;user=<?php echo $booking['user_id']; ?>&amp;month=<?php echo $this->date['next_M_time']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Place <?php echo $this->date['next_M']; ?> Order</a></li>
							<li><a href="main.php?page=admin_order_history&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Order History</a></li>
							<?php if ($this->store_supports_plate_points && $booking['dream_rewards_version'] != 3) { ?>
								<li><a href="main.php?page=admin_user_plate_points&amp;id=<?php echo $booking['user_id']; ?>&amp;print_enrollment_form=true&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>" target="_blank">PP Enroll Form</a></li>
							<?php } ?>

							<?php if ($booking['status'] != CBooking::SAVED) { ?>
								<li><a href="main.php?page=print&amp;order=<?php echo $booking['order_id']; ?>&amp;freezer=true" target="_blank">Freezer Sheet</a></li>
								<li><a href="main.php?page=print&amp;order=<?php echo $booking['order_id']; ?>&amp;core=true&amp;cur=true" target="_blank">This Month's Menu</a></li>
								<li><a href="main.php?page=print&amp;order=<?php echo $booking['order_id']; ?>&amp;core=true" target="_blank">Next Month's Menu</a></li>
								<li><a href="main.php?page=print&amp;order=<?php echo $booking['order_id']; ?>&amp;nutrition=true" target="_blank">Nutritionals</a></li>
								<li><a href="main.php?page=admin_order_details_view_all&amp;customer_print_view=1&amp;session_id=<?php echo $booking['session_id']; ?>&amp;booking_id=<?php echo $booking['id']; ?>&amp;menuid=<?php echo $booking['menu_id']; ?>" target="_blank">Order Summary</a></li>
								<!--li>
									<p style="font-size: 10px;display:inline;">6-up&nbsp;<a href="main.php?page=admin_reports_customer_menu_item_labels&amp;session_id=<?php echo $booking['session_id']; ?>&amp;booking_id=<?php echo $booking['id']; ?>&amp;store_id=<?php echo $booking['store_id']; ?>&amp;menuid=<?php echo $booking['menu_id']; ?>&amp;suppressFastlane=true" target="_blank">Labels</a> &bull;
									<a href="main.php?page=admin_reports_customer_menu_item_labels&amp;session_id=<?php echo $booking['session_id']; ?>&amp;booking_id=<?php echo $booking['id']; ?>&amp;store_id=<?php echo $booking['store_id']; ?>&amp;menuid=<?php echo $booking['menu_id']; ?>&amp;suppressFastlane=false" target="_blank">w/ FL</a>
									</p>
								</li-->
								<li>
									<p style="font-size: inherit;display:inline;"><a href="main.php?page=admin_reports_customer_menu_item_labels&amp;labels_per_sheet=4&amp;session_id=<?php echo $booking['session_id']; ?>&amp;booking_id=<?php echo $booking['id']; ?>&amp;store_id=<?php echo $booking['store_id']; ?>&amp;menuid=<?php echo $booking['menu_id']; ?>&amp;suppressFastlane=true" target="_blank">Labels</a> &bull;
										<a href="main.php?page=admin_reports_customer_menu_item_labels&amp;labels_per_sheet=4&amp;&amp;session_id=<?php echo $booking['session_id']; ?>&amp;booking_id=<?php echo $booking['id']; ?>&amp;store_id=<?php echo $booking['store_id']; ?>&amp;menuid=<?php echo $booking['menu_id']; ?>&amp;suppressFastlane=false" target="_blank">w/ FL</a>
									</p>
								</li>
								<li><a href="main.php?page=admin_session_tools_printing&amp;do=print&amp;user_id=<?php echo $booking['user_id']; ?>&amp;session=<?php echo $booking['session_id']; ?>&amp;store_id=<?php echo $booking['store_id']; ?>&amp;core=true&amp;freezer=true&amp;nutrition=true" target="_blank">Collated Docs</a></li>
				...
				<td class="value small_value">
					<?php if (!empty($booking['can_edit'])) { ?>
					<a href="main.php?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">
						<?php } else { ?>
						<a href="main.php?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">
							<?php } ?>
			...
			<?php if ($booking['status'] == CBooking::ACTIVE) { ?>
				<tr>
					<?php if ($booking['user']->membershipData['status'] == CUser::MEMBERSHIP_STATUS_CURRENT) { ?>
						...
						<td class="value small_value"><a href="main.php?page=admin_user_membership&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>"><?php echo $booking['user']->membershipData['display_strings']['progress']; ?></a></td>
						<td class="title">MP+ Skip Avail</td>
						<td class="value small_value"><a href="main.php?page=admin_user_membership&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>"><?php echo $booking['user']->membershipData['remaining_skips_available']; ?></a></td>
					<?php } else  {?>
						...
						<td class="value small_value">
							<?php if ($booking['dream_reward_status'] == 1 || $booking['dream_reward_status'] == 3) {
								if ($booking['dream_rewards_version'] < 3) { ?>
									Yes
								<?php } else { ?>
									<div><span data-pp_user_lifetime_points="<?php echo $booking['user_id']; ?>"><a id="pp_credit_<?php echo $booking['user_id']; ?>_<?php echo $booking['order_id']; ?>" href="main.php?page=admin_user_plate_points&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">$<?php echo CTemplate::moneyFormat($booking['user']->platePointsData['available_credit']); ?></a></span></div>
								<?php } } else { ?>
						...
						<td class="value small_value">
							...
							<?php }else{
								if (($booking['dream_reward_status'] == 1 || $booking['dream_reward_status'] == 3) && $booking['dream_rewards_version'] == 3) {
									...
									<?php if ($booking['dream_reward_status'] == 5) { ?>
										<a class="button" href="main.php?page=admin_user_plate_points&amp;id=<?php echo $booking['user_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">PlatePoints</a>
									<?php } else { ?>
										<a class="button" href="main.php?page=admin_account&amp;id=<?php echo $booking['user_id']; ?>&amp;pp_enroll=1&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>">Enroll in PlatePoints</a>
									<?php } ?>
								<?php }
							}?>
						</td>
				...
				<tr>
					...
					<td class="value small_value"><a href="main.php?page=admin_order_history&amp;id=<?php echo $booking['user_id']; ?>&back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>"><?php echo (!empty($booking['bookings_made'])) ? $booking['bookings_made'] : 0; ?></a></td>
				</tr>
				<?php
			...
			<tr>
				<td colspan="7" class="title" style="text-align: left;">
					...
					<div style="float: right;">
						<?php if (!empty($booking['can_edit'])) { ?>
							<a href="main.php?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>" class="button">Edit Order</a>
						...
						<?php } else { ?>
							<a href="main.php?page=admin_order_mgr&amp;order=<?php echo $booking['order_id']; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $booking['session_id']; ?>" class="button">Edit Payments</a>
						...
						<?php } ?>
						<a href="main.php?page=admin_order_details_view_all&amp;customer_print_view=1&amp;session_id=<?php echo $booking['session_id']; ?>&amp;booking_id=<?php echo $booking['id']; ?>&amp;menuid=<?php echo $booking['menu_id']; ?>" class="button" target="_blank">Print</a>
			...
			<?php foreach ($this->session_info['session_rsvp'] AS $session_rsvp) { ?>
				<tr id="session_rsvp-<?php echo $this->session_info['id']; ?>-<?php echo $session_rsvp->user->id; ?>">
					...
					<td colspan="3" class="value" style="text-align: center;">
						...
						<?php } ?>
						<a class="button" href="main.php?page=admin_user_details&amp;id=<?php echo $session_rsvp->user->id; ?>&amp;back=main.php%3Fpage%3Dadmin_main%26session%3D<?php echo $this->session_info['id']; ?>">View Guest</a></li>

...
?>
	...
	<h2 id="gd_title-<?php echo $this->session_info['id'];?>" data-session_id="<?php echo $this->session_info['id'];?>">
		<?php if ($this->session_info['session_type_subtype'] == CSession::WALK_IN) { ?>
			<?php echo CTemplate::dateTimeFormat($this->session_info['session_start'], MONTH_DAY_YEAR); ?>
		<?php } else { ?>
			<?php echo CTemplate::dateTimeFormat($this->session_info['session_start'], TIME_ONLY); ?> - <?php echo CTemplate::dateTimeFormat($this->session_info['session_end'], TIME_ONLY); ?>
		<?php } ?>
		- <?php echo temp_translateMYF_to_Pickup($this->session_info['session_type_title']); ?>
	</h2>

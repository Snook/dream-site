<div id="ilgs_container">
	...
	<div>
		...
		<span id="ilgs_search_go" class="btn btn-primary btn-sm">Search</span> <img src="<?php echo ADMIN_IMAGES_PATH; ?>/style/throbber_circle.gif" class="img_valign img_throbber_circle" data-tooltip="Processing" alt="Processing" />

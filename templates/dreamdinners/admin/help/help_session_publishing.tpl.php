...
<p>The key to quickly publishing your schedule is the weekly template. The idea here is that your schedule often follows a weekly pattern. By specifying a weekly template that follows this pattern you can
...
<ol>
 <li>Specify a Time Span.
  ...
  <li>Fill the Time Span from a template.
 	A template is selected from the template popup menu. The "Fill from Template" button is clicked. The new sessions are shown with a Blue icon. These sessions do not yet exist and cannot be edited.</li>
...
The Pubish Interface is shown below:
 <img src="<?php echo ADMIN_IMAGES_PATH; ?>/help/publish_sessions_example.png" class="img-fluid">

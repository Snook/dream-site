				...
				<br />
							...
							<table width="100%">
								<tr>
									...
									<span id="gd_cancel_order-<?php echo $this->orderInfo['id']; ?>" data-user_id="<?php echo $this->orderInfo['user_id']; ?>" data-store_id="<?php echo $this->orderInfo['store_id']; ?>" data-session_id="<?php echo $this->sessionInfo['id']; ?>" data-order_id="<?php echo $this->orderInfo['id']; ?>" data-bounce="/backoffice/main" class="button">Cancel Order</span>
								<?php } ?>

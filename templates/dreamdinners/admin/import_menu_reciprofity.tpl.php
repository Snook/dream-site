	...
	<div class="container-fluid">
		...
		<div class="row my-4">
			<div class="col-lg-6 text-center mb-3 order-lg-2">
				<h1><a href="main.php?page=admin_import_menu_reciprofity">Import Menu Items</a></h1>
			</div>
		...
		<?php } else { ?>
			...
			<p>Menu imported, view the <a href="main.php?page=admin_menu_inspector&menus=<?php echo $this->menu_id; ?>" class="button">Menu Inspector</a> to verify.</p>

...
<?php if ($this->show['store_selector'] && !empty($this->form_session_list['store_html'])) { ?>
	<div id="store_selector">
		<form method="post">
			Store: <?php echo $this->form_session_list['store_html']; ?>
		</form>
	</div>
<?php } ?>
...
<?php } else { ?>
	...
	<div id="detailed_reporting" class="collapse mt-3">
		...
		<div>
			...
			<?php echo $this->form_session_list['offsitelocation_chooser_html']; ?><br /><br />
		...
		<?php if (!empty($this->OffsitelocationArray)) { ?>
			<?php foreach ($this->OffsitelocationArray AS $id => $offsitelocation) { ?>
				<tr data-offsite_id="<?php echo $id; ?>">
					...
					<td><?php if (!empty($offsitelocation->contact_user_id)) { ?><a href="main.php?page=admin_user_details&amp;id=<?php echo $offsitelocation->contact_user_id; ?>"><?php echo $offsitelocation->firstname; ?> <?php echo $offsitelocation->lastname; ?></a><?php } else { ?>None<?php } ?></td>

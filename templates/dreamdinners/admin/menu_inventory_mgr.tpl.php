	...
	<table class="ME_menu_editor_table" style="width:100%;">
		...
		<tr>
			...
			<td align="left" style="padding-left: 10px;">
				<a href="main.php?page=admin_menu_editor&tabs=menu.specials" class="btn btn-primary btn-sm" id="inv_mgr">Menu Editor</a>
			</td>
		</tr>
	</table>
	<div class="row" >
									...
									if (is_array($planNode) && $planNode['pricing_type'] == CMenuItem::FULL)
									{
										...
										<tr id="row_<?= $planNode['id'] ?>" data-menu_item_id="<?= $planNode['id'] ?>" data-ltd_menu_item_value="<?= $planNode['ltd_menu_item_value'] ?>">
											...
											<td nowrap align="left" class="ME_zebra_even" style="padding: 2px;">
												...
												<a href="main.php?page=item&amp;recipe=<?php echo $planNode['recipe_id']; ?>&amp;ov_menu=<?php echo $this->menuInfo['menu_id'];?>" data-tooltip="Item Page" target="_blank">&gt;</a>
							...
							{ ?>
								<tr id="row_<?= $ctsItem['id'] ?>" data-menu_item_id="<?= $ctsItem['id'] ?>" data-ltd_menu_item_value="<?= $ctsItem['ltd_menu_item_value'] ?>">
									...
									<td nowrap align="left" class="ME_zebra_even" style="padding: 2px;">
										...
										<a href="main.php?page=item&amp;recipe=<?php echo $ctsItem['recipe_id']; ?>&amp;ov_menu=<?php echo $this->menuInfo['menu_id'];?>" data-tooltip="Item Page" target="_blank">&gt;</a>

...
<h3>User History for <a href="/backoffice/user-details?id=<?php echo $this->user_info->id ?>"><?php echo $this->user_info->firstname ?> <?php echo $this->user_info->lastname ?></a></h3>

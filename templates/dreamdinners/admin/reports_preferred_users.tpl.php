	...
	<div class="container-fluid">
		...
		<div class="row my-4">
			<div class="col text-center">
				<h1><a href="main.php?page=admin_reports_preferred_users">Preferred Users Report</a></h1>
			</div>
		</div>
		...
		<?php if (isset($this->rows) && count($this->rows) > 0) { ?>
			...
			<table class="table table-striped table-bordered table-hover ddtemp-table-border-collapse bg-white">
				...
				<?php foreach ($this->rows as $entity) { ?>
					<tr>
						<td><a href="main.php?page=admin_preferred&id=<?php echo $entity['id']; ?>"><?php echo $entity['id']; ?></a></td>
						<td>
							<div class="mb-2"><?php echo $entity['firstname']; ?> <?php echo $entity['lastname']; ?></div>
							<div><a href="main.php?page=admin_email&id=<?php echo $entity['id']; ?>"><?php echo $entity['primary_email']; ?></a></div>
						</td>

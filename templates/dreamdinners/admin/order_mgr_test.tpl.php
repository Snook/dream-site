			...
			<tr>
			 ...
			 <?php } ?>
				...
				<div id="update_console">
					<span id="addPaymentAndActivate"><input id="addPaymentAndActivateButton" class="button" disabled="disabled" onclick="addPaymentAndActivate(this); return false;" value="Add Payment and Book Order" style="width:200px;" /></span>

...
if (isset($this->report_submitted) && $this->report_submitted == TRUE) {
	if ( isset($this->royalty_data) && $this->royalty_data != "" && ($this->royalty_data) > 0) {
		...
		//$exportAllLink = '/backoffice/reports_site_royalty_national?day=' . $this->report_day . '&month=' . $this->report_month . '&year=' . $this->report_year . '&duration=' . urlencode($this->report_duration) . '&report_type=' . $this->report_type .  '&export=csv';

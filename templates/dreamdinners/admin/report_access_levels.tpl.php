...
<tr>
	<td class="bgcolor_lighter"><a href="main.php?page=admin_user_details&id=<?php echo $user['id']; ?>"><?php echo $user['id']; ?></a></td>
	<td class="bgcolor_light"><a href="main.php?page=admin_access_levels&amp;id=<?php echo $user['id']; ?>"><?php echo CUser::userTypeText($user['user_type']); ?></a></td>

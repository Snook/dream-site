<div class="row">
	<div class="col-6">
		<table class="table ddtemp-table-border-collapse">
			...
			<tr>
				<td>
					<a href="/backoffice/reports-meal-prep-plus" <?php if ($this->CurrentBackOfficeStore->isDistributionCenter()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for Distribution Centers"<?php } ?>>Meal Prep+ Report</a><br/>
					<a href="/backoffice/reports-food-sales">Menu Item Sales Report</a><br/>
					<a href="/backoffice/reports-session-host" <?php if ($this->CurrentBackOfficeStore->isDistributionCenter()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for Distribution Centers"<?php } ?>>Session Host Report</a><br/>
					...
					<a href="/backoffice/reports-points-status-by-date" <?php if (!$this->CurrentBackOfficeStore->supportsPlatePoints()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for stores that do not support PLATEPOINTS"<?php } ?>>PLATEPOINTS Awards</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="col-6">
		<table class="table ddtemp-table-border-collapse">
			...
			<tr>
				<td>
					<a href="/backoffice/session-tools-printing" <?php if ($this->CurrentBackOfficeStore->isDistributionCenter()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for Distribution Centers"<?php } ?>>Generic Menu Supporting Documents</a><br/>
					<a href="/backoffice/reports-customer-menu-item-labels?interface=1" <?php if ($this->CurrentBackOfficeStore->isDistributionCenter()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for Distribution Centers"<?php } ?>>Generic Cooking Instruction Labels</a><br/>
					<a href="/backoffice/reports-menu-item-nutritional-labels" <?php if ($this->CurrentBackOfficeStore->isDistributionCenter()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for Distribution Centers"<?php } ?>>Nutritional Labels</a><br/>
					<a href="/backoffice/user-plate-points?print_blank_form=true" target="_blank" <?php if (!$this->CurrentBackOfficeStore->supportsPlatePoints()) { ?>class="text-decoration-line-through" data-toggle="tooltip" data-placement="top" title="Not available for stores that do not support PLATEPOINTS"<?php } ?>>Blank PLATEPOINTS Enrollment Form</a><br/>
				</td>
			</tr>
		</table>

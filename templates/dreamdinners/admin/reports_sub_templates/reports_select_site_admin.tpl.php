<div style="width:750px; margin-left:auto; margin-right:auto;">
	<div style="float:left;">
		<table style="width: 100%;">
			<tr>
				<td class="form_subtitle_cell"><a href="main.php?page=admin_main"><b>BackOffice Home</b></a><br/><br/></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					<a href="main.php?page=admin_reports_trending_new">Rolling 13-Month Business Analysis Report (<span style="color:red">beta</span>)</a><br/>
					<a href="main.php?page=admin_reports_goal_management_v2">Goal Management</a><br/>
					...
					<a href="main.php?page=admin_reports_same_store_sales">Same Store Sales Report</a><br/>
					<a href="main.php?page=admin_reports_dashboard_aggregate_v2">Dashboard Aggregate Report</a><br/>
					...
					<a href="main.php?page=admin_reports_business_health_assessment">Business Health Assessment</a><br/>
					<br/><br/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<a href="main.php?page=admin_reports_meal_prep_plus">Meal Prep+ Report</a><br/>
	...
	<div style="float:right">
		...
		<?php if (defined('DD_SERVER_NAME') && DD_SERVER_NAME == 'HO_REPORTING') {?>
			<table style="width: 100%;">
				...
				<tr>
					<td>
						<a href="main.php?page=admin_home_office_reports_site_aggregate_samestore">Same Store Sales Site Aggregate Report</a><br/>
						<a href="main.php?page=admin_home_office_reports_dashboard_aggregate">Dream Dashboard Aggregate</a><br/>
						<a href="main.php?page=admin_home_office_reports_weekly_metrics">Weekly Metrics Report (<span style="color:red">beta</span>)</a><br/>
						<a href="main.php?page=admin_home_office_reports_guest_metrics">Guest Metrics Report (<span style="color:red">beta</span>)</a><br/>
					</td>
				</tr>
			</table>
		...
		<table style="width: 100%;">
			...
			<tr>
				<td>
					...
					<a href="main.php?page=admin_reports_food_and_labor_costs">Food and Labor Costs (<span style="color:red">beta</span>)</a><br/>
					<a href="main.php?page=admin_performance_override">Performance Override Form</a><br/>
					<a href="main.php?page=admin_reports_site_royalty_national">Royalty Report by Store</a><br/>
					<a href="main.php?page=admin_reports_store_contact_information&amp;format=store&amp;export=xlsx">Store Contact Information by Store</a><br/>
					<a href="main.php?page=admin_reports_store_contact_information&amp;format=owner&amp;export=xlsx">Store Contact Information by Owner</a><br/>
					<a href="main.php?page=admin_reports_my_meals">My Meals Ratings</a><br/>
					<a href="main.php?page=admin_reports_my_meals_comments">My Meals Comments</a><br/>
					<a href="main.php?page=admin_food_testing">Food Testing Manager</a><br/>
					<a href="main.php?page=admin_food_testing_survey">Food Testing Store Surveys</a><br/>
					<a href="main.php?page=admin_reports_menu_skipping">Menu Skipping Report (<span style="color:red">beta</span>)</a><br/>
					<a href="main.php?page=admin_reports_door_dash_import">Door Dash Report & Import</a><br/>
					<a href="main.php?page=admin_reports_meal_prep_plus_site_wide">Meal Prep+ Subscriptions (All stores)</a><br/>
					<a href="main.php?page=admin_reports_national_entree_projection">Master Preorder Export</a><br/>
					<a href="main.php?page=admin_reports_menu_planning">Menu Planning Report</a><br/>
				</td>
			</tr>
		</table>
	</div>

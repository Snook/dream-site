...
<table style="width: 100%;">
	...
	<tr>
		<td>
			...
			<a href="/?page=admin_reports_goal_management_v2">Session Summary and Goal Setting</a><br/>
			...
			<?php } ?>
            <a href="/?page=admin_reports_trending_new">Rolling 13-Month Business Analysis Report</a><br/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<a href="/?page=admin_reports_door_dash_import">Door Dash Report</a><br/>
...
<table style="width: 100%;">
	...
	<tr>
		<td>
			...
			<a href="/?page=admin_reports_customer_menu_item_labels&interface=1">Generic Cooking Instruction
				Labels</a><br/>
			<?php if (!$this->storeIsDistributionCenter) { ?>

...
class DD_Selenium_Test_Order_Utils
{
	...
	static function placeStandardFadminOrder($driver, $session_id, $user_id)
	{
		...
		$driver->get($baseURL . "/main.php?page=admin_start_new_test_order&session_id=" . $session_id . "&user_id=" . $user_id);
	...
	static function loadGiftCard($driver)
	{
		...
		$driver->get($baseURL . "/main.php?page=admin_gift_card_load");

					...
					success: function (json) {
						if (json.processor_success)
						{
							...
							$('#sd_invitation_pdf').on('click', function (e) {
								...
								bounce('/print?dream_taste_event_pdf=' + selected_session_id, '_blank');

							});

							// fundraiser buttons
							$('#sd_fundraiser_invitation_pdf').on('click', function (e) {
								bounce('/print?fundraiser_event_pdf=' + selected_session_id, '_blank');
							...
							$('#sd_pick_up_event_invitation_pdf').on('click', function (e) {
								...
								bounce('/print?remote_pickup_private_event_pdf=' + selected_session_id, '_blank');
...
function update_session_tool_links()
{
	...
	else
	{
		...
		$('#st_print_labels_w_breaks').prop('href', '/backoffice/reports_customer_menu_item_labels_multi?labels_per_sheet=4&report_date=' + selected_date + '&store_id=' + STORE_DETAILS.id + '&menuid=' + selected_menu_id + '&back=' + back_path() + '&break=1&suppressFastlane=' + suppress_fastlane_labels).prop('target', '_blank');
		$('#st_print_labels_by_dinner').prop('href', '/backoffice/reports_customer_menu_item_labels_multi?labels_per_sheet=4&report_date=' + selected_date + '&store_id=' + STORE_DETAILS.id + '&menuid=' + selected_menu_id + '&order_by=dinner&back=' + back_path() + '&suppressFastlane=' + suppress_fastlane_labels).prop('target', '_blank');

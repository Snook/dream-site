...
function handle_order_details_click()
{
	$('[data-view_order_details]').each(function ()
	{
		...
		$(this).on('click', function (e)
		{
			...
			{
				historyPush({url: '?page=' + getQueryVariable('page') + '&id=' + getQueryVariable('id')});
			...
			$.ajax({
				...
				success: function (json)
				{
					if (json.processor_success)
					{
						...
						historyPush({url: '?page=' + getQueryVariable('page') + '&id=' + getQueryVariable('id') + '&order=' + json.order_id});
					}
				},

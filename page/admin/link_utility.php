...
class page_admin_link_utility extends CPageAdminOnly
{
	...
	function runSiteAdmin()
	{
		...
		while ($Sessions->fetch())
		{
			$daterArray[$Sessions->id] = array(
				...
				'type' => ($Sessions->session_type == 'SPECIAL_EVENT' ? "MADE FOR YOU" : $Sessions->session_type),

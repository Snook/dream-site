...
class page_admin_reports_session_host extends CPageAdminOnly
{
    ...
    $outerQueryEnd = " ) as iq
		...
		while ($session->fetch())
		{
            ...
            $tarray['session_start'] = "=HYPERLINK(\"" . HTTPS_SERVER . WEB_BASE . "?page=admin_main&session=" . $tarray['session_id'] . "\", \"{$tarray['session_start']}\")";
            $thisHost = $tarray['session_host'];
            $tarray['session_host'] = "=HYPERLINK(\"" . HTTPS_SERVER . WEB_BASE . "?page=admin_user_details&id=" . $tarray['session_host'] . "\", \"{$tarray['session_host']}\")";
            $tarray['primary_email'] = "=HYPERLINK(\"" . HTTPS_SERVER . WEB_BASE . "?page=admin_email&id=" . $thisHost . "\", \"{$tarray['primary_email']}\")";

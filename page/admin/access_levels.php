...
class page_admin_access_levels extends CPageAdminOnly
{
	...
	function runAccessLevels()
	{
		...
		form_account::$forwardTo = 'main.php?page=admin_list_users';
		$prevUserType = null;
		$id = null;
		$user_type = null;

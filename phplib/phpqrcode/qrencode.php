 ...
 */
    ...
    class QRcode {
		...
		//----------------------------------------------------------------------
		public static function pngWeb($text, $size = 3, $fileName = null )
		{
			$enc = QRencode::factory(QR_ECLEVEL_L, $size, 4, 0xFFFFFF, 0x000000);
			return $enc->encodePNG($text, false, false, $fileName);
		}
    ...
    class QRencode {
        ...
        //----------------------------------------------------------------------
        public function encodePNG($intext, $outfile = false, $saveandprint=false , $fileName = null)
        {
            try {
                ...
                QRimage::png($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin,$saveandprint, $this->back_color, $this->fore_color, $fileName);

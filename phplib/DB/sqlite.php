...
class DB_sqlite extends DB_common
{
    ...
    function connect($dsn, $persistent = false)
    {
        ...
        if (!$this->connection = @$connect_function($dsn['database'])) {
            return $this->raiseDBError(DB_ERROR_NODBSELECTED,
                                     null, null, null,
                                     $php_errormsg);
        }
        return DB_OK;
    ...
    function sqliteRaiseError($errno = null)
    {
        ...
        return $this->raiseDBError($errno, null, null, $userinfo, $native);
    }
    ...
    function tableInfo($result, $mode = null)
    {
        if (is_string($result)) {
            ...
            $this->last_query = '';
            return $this->raiseDBError(DB_ERROR_NOT_CAPABLE, null, null, null,

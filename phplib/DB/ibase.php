...
class DB_ibase extends DB_common
{
    ...
    function connect($dsn, $persistent = false)
    {
        ...
        if (!$this->connection) {
            return $this->ibaseraiseDBError(DB_ERROR_CONNECT_FAILED);
        }
        return DB_OK;
    }
    ...
    function &execute($stmt, $data = array())
    {
        ...
        if (count($types) != count($data)) {
            $tmp = $this->raiseDBError(DB_ERROR_MISMATCH);
            return $tmp;
        }
        ...
        foreach ($data as $key => $value) {
            if ($types[$i] == DB_PARAM_MISC) {
                ...
                if (!$fp) {
                    $tmp = $this->raiseDBError(DB_ERROR_ACCESS_VIOLATION);
                    return $tmp;
                }
    ...
    function &ibaseRaiseError($errno = null)
    {
        ...
        $tmp = $this->raiseDBError($errno, null, null, null, @ibase_errmsg());
        return $tmp;
    }

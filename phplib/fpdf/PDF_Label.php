	...
	*/
	...
	function getRecipeQrCodePath($recipeId, $forceQrRegen = false)
	{
		...
		if (!file_exists($path) || $forceQrRegen)
		{
			...
			$frame_Size: This specifies the size of Qr. It is from level 1-10.*/ //			QRcode::png('https://dreamdinners.com/?page=item&recipe='.$recipeId,$path,QR_ECLEVEL_L,3,4,false,0xFFFFFF,
			//				0x959a21);
			QRcode::png(HTTP_SERVER . '/?page=item&recipe=' . $recipeId . '&utm_source=qr-code&utm_medium=cooking-instructions&utm_campaign=' . $recipeId, $path, QR_ECLEVEL_L, 3, 4, false);
		}
	...
	function getNutritionQrCodePath($recipeId, $forceQrRegen = false)
	{
		...
		if (!file_exists($path) || $forceQrRegen)
		{
			...
			$frame_Size: This specifies the size of Qr. It is from level 1-10.*/ //			QRcode::png('https://dreamdinners.com/?page=item&recipe='.$recipeId,$path,QR_ECLEVEL_L,3,4,false,0xFFFFFF,
			//				0x959a21);
			QRcode::png(HTTP_SERVER . '/?page=item&recipe=' . $recipeId . '&tab=nutrition&utm_source=qr-code&utm_medium=nutritionals&utm_campaign=' . $recipeId, $path, QR_ECLEVEL_L, 3, 4, false);
		}

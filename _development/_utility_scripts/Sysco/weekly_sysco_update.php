...
//$tempDirectory = "C:\\Users\\Carl.Samuelson\\Zend\workspaces\\DefaultWorkspace12\\DreamSite\\";


/*
$local_file = "C:\\Users\\Carl.Samuelson\\Zend\workspaces\\DefaultWorkspace12\\DreamSite\\005_613719632";
$output_file = "C:\\Users\\Carl.Samuelson\\Zend\workspaces\\DefaultWorkspace12\\DreamSite\\converted_005_613719632.csv";

if (substr($output_file, -4) != ".csv")
	$output_file .=  ".csv";

	CSysco_EDI_Parser::parseFile($local_file, $output_file);
...
{
	$sendMail = mail( "ryan.snook@dreamdinners.com, evan.lee@dreamdinners.com, josh.thayer@dreamdinners.com, lori.pierce@dreamdinners.com, lorie.wiseman@dreamdinners.com", "Weekly Sysco Input Report",

...
$storeEmailAdditions = array(
	'280' => 'deana.fulbright@dreamdinners.com', //SJ
	'244' => 'deana.fulbright@dreamdinners.com,melissa.dixon@dreamdinners.com' //MC
);
...
function sendReport($data)
{
	...
	{
		$sendMail = mail( "ryan.snook@dreamdinners.com,evan.lee@dreamdinners.com,deana.fulbright@dreamdinners.com", "Nightly Sysco Invoice Routing Report",
			$data, 'From: <do-not-reply@dreamdinners.com>' );
	}
}

...
function fetchZipcodes(  )
{
	...
	szZip = document.getElementById('zip_for_search').value;
	document.getElementById('selTarget').style.display = "block";	

	if( szZip && (szZip.length > 4) && (szZip != g_lastSearch) ) {
		g_lastSearch = szZip;
	   ...
	   var url = "ajax/account/fetchZipcodes.php";
	   url=url + "?szZip=" + szZip;
